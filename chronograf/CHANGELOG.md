...
1.  [#536](https://github.com/influxdata/platform/chronograf/issues/536) Redirect the user to the kapacitor config screen if they are attempting to view or edit alerts without a configured kapacitor
