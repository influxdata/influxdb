...
impl TableBuffer {
    ...
    pub fn add_snapshot_chunks(&mut self, snapshot_chunks: Vec<SnapshotChunk>) {
        self.snapshotting_chunks = snapshot_chunks;
    }

    pub fn add_snapshot_chunk(&mut self, snapshot_chunk: SnapshotChunk) {
        self.snapshotting_chunks.push(snapshot_chunk);
    }
...
mod tests {
    ...
    use data_types::{NamespaceName, TableId};
