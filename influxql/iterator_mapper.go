...
// IteratorMap is an interface that provides means of retrieving an iterator by an arbitrary key.
...
// Value provides the iterator in the Nth position in buf, beinf N the reciever's value.
...
// Value provides the iterator mapped to the reciever's tag
