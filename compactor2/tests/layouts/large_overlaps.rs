...
async fn one_l1_overlaps_with_many_l2s() {
    ...
    - "  Creating 4 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[59, 117]). 4 Input Files, 259.44mb total:"
    - "L1                                                                                                                 "
...
async fn many_l1_overlaps_with_many_l2s() {
    ...
    - "  Creating 2 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[87, 123]). 9 Input Files, 278mb total:"
    - "L1                                                                                                                 "
    - "L1.4[61,75] 240s 13mb             |---L1.4---|                                                                     "
    - "L1.5[76,90] 300s 13mb                          |---L1.5---|                                                        "
...
async fn many_good_size_l0_files() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[50, 100]). 150 Input Files, 300mb total:"
    - "L0, all files 2mb                                                                                                  "
    - "L0.1[0,1] 1ns            |L0.1|                                                                                    "
    - "L0.2[1,2] 2ns            |L0.2|                                                                                    "
    - "L0.3[2,3] 3ns             |L0.3|                                                                                   "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[200, 250]). 138 Input Files, 276mb total:"
    - "L0, all files 2mb                                                                                                  "
    - "L0.151[150,151] 151ns    |L0.151|                                                                                  "
    - "L0.152[151,152] 152ns    |L0.152|                                                                                  "
    - "L0.153[152,153] 153ns     |L0.153|                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[137, 223]). 3 Input Files, 278mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 3, type=split(ReduceOverlap)(split_times=[223]). 1 Input Files, 98mb total:"
    - "L0, all files 98mb                                                                                                 "
    - "L0.293[201,250] 288ns    |-----------------------------------------L0.293-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 98mb total:"
    - "L0                                                                                                                 "
    - "L0.?[201,223] 288ns 44mb |-----------------L0.?-----------------|                                                  "
    - "L0.?[224,250] 288ns 54mb                                           |--------------------L0.?---------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L0.293"
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[181]). 2 Input Files, 199.7mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 5, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[221, 260]). 4 Input Files, 274.1mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 6, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[261]). 2 Input Files, 173.25mb total:"
    - "L1                                                                                                                 "
