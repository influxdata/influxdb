...
async fn many_good_size_l0_files() {
    ...
    - "  Creating 3 files"
    - "**** Simulation run 2, type=split(split_times=[137, 223]). 3 Input Files, 278mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 3, type=split(split_times=[223]). 1 Input Files, 98mb total:"
    - "L0, all files 98mb                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(split_times=[181]). 2 Input Files, 199.7mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 5, type=split(split_times=[221, 260]). 4 Input Files, 274.1mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 6, type=split(split_times=[261]). 2 Input Files, 173.25mb total:"
    - "L1                                                                                                                 "
