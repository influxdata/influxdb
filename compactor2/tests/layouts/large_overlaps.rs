...
async fn one_l1_overlaps_with_many_l2s() {
    ...
    - "L1.9[201,250] 240s 19.68mb                                |L1.9-|                                         "
    - "L2                                                                                                  "
    - "L2.2[101,150] 60s 100mb                |L2.2-|                                                         "
    - "L2.3[151,200] 120s 70mb                        |L2.3-|                                                 "
    - "L2.10[1,72] 240s 100.23mb|--L2.10--|                                                                     "
    - "L2.11[73,100] 240s 38.12mb           |L2.11|                                                              "
    "###
    );
}
...
async fn many_l1_overlaps_with_many_l2s() {
    ...
    - "L1.13[101,105] 360s 3.71mb                                        |L1.13|                                 "
    - "L1.7[106,120] 420s 13mb                                            |--L1.7---|                         "
    - "L2                                                                                                  "
    - "L2.1[51,100] 0ns 100mb|----------------L2.1-----------------|                                         "
    - "L2.2[101,150] 60s 100mb                                        |----------------L2.2-----------------| "
    ...
    - "L2                                                                                                  "
    - "L2.?[51,91] 420s 101.44mb|-------------L2.?-------------|                                                "
    - "L2.?[92,131] 420s 98.91mb                                 |------------L2.?-------------|                "
    - "L2.?[132,150] 420s 45.65mb                                                                 |----L2.?----| "
    - "Committing partition 1:"
    ...
    - "L2                                                                                                  "
    - "L2.3[151,200] 120s 70mb                                                |--------L2.3---------|         "
    - "L2.14[51,91] 420s 101.44mb|------L2.14------|                                                             "
    - "L2.15[92,131] 420s 98.91mb                    |------L2.15------|                                         "
    - "L2.16[132,150] 420s 45.65mb                                       |L2.16-|                                 "
    "###
    );
}
...
async fn many_good_size_l0_files() {
    ...
    - "L0                                                                                                  "
    - "L0.296[282,288] 1ns 12mb                                                                           |L0.296|"
    - "L0.295[256,281] 1ns 50mb                                                        |-----L0.295-----|      "
    - "L0.294[229,256] 1ns 54mb                                    |-----L0.294------|                         "
    - "L0.293[179,228] 1ns 98mb|-------------L0.293--------------|                                             "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 210.07mb total:"
    - "L1                                                                                                  "
    - "L1.?[179,230] 1ns 100.13mb|---------------L1.?----------------|                                           "
    - "L1.?[231,281] 1ns 98.17mb                                      |---------------L1.?---------------|      "
    - "L1.?[282,288] 1ns 11.78mb                                                                           |L1.?|"
    - "Committing partition 1:"
    ...
    - "L0.291[101,128] 1ns 54mb                               |----L0.291-----|                                "
    - "L0.292[128,178] 1ns 100mb                                                |-----------L0.292------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 248.03mb total:"
    - "L1                                                                                                  "
    - "L1.?[51,102] 1ns 101.2mb|-------------L1.?-------------|                                                "
    - "L1.?[103,153] 1ns 99.21mb                                |------------L1.?-------------|                 "
    - "L1.?[154,178] 1ns 47.62mb                                                                |----L1.?-----| "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L0.290, L0.291, L0.292"
    - "  Creating 3 files at level CompactionLevel::L1"
    - "**** Simulation run 5, type=split(split_times=[155, 207]). 3 Input Files, 246.96mb total:"
    - "L1                                                                                                  "
    - "L1.301[103,153] 1ns 99.21mb|-----------L1.301------------|                                                 "
    - "L1.302[154,178] 1ns 47.62mb                                |---L1.302----|                                 "
    - "L1.297[179,230] 1ns 100.13mb                                               |------------L1.297------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 243.07mb total:"
    - "L2                                                                                                  "
    - "L2.?[103,155] 1ns 101.12mb|-------------L2.?-------------|                                                "
    - "L2.?[156,207] 1ns 99.17mb                                 |-------------L2.?-------------|               "
    - "L2.?[208,230] 1ns 42.78mb                                                                  |---L2.?----| "
    - "Committing partition 1:"
    ...
    - "L1                                                                                                  "
    - "L1.299[282,288] 1ns 11.78mb                                                                       |L1.299| "
    - "L1.298[231,281] 1ns 98.17mb|-------------------------------L1.298-------------------------------|          "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 108.02mb total:"
    - "L2                                                                                                  "
    - "L2.?[231,276] 1ns 86.8mb|----------------------------L2.?-----------------------------|                 "
    - "L2.?[277,288] 1ns 21.22mb                                                                |----L2.?-----| "
    - "Committing partition 1:"
    ...
    - "L2.300[51,102] 1ns 101.2mb              |---L2.300---|                                                    "
    - "L2.303[103,155] 1ns 101.12mb                            |---L2.303---|                                      "
    - "L2.304[156,207] 1ns 99.17mb                                           |---L2.304---|                       "
    - "L2.305[208,230] 1ns 42.78mb                                                         |L2.305|               "
    - "L2.306[231,276] 1ns 86.8mb                                                                |--L2.306--|    "
    - "L2.307[277,288] 1ns 21.22mb                                                                            |L2.307|"
    "###
    );
}
