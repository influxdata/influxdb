...
async fn one_l1_overlaps_with_many_l2s() {
    ...
    - "L1.9[201,250] 20.88mb                                |L1.9-|                                         "
    - "L2                                                                                                  "
    - "L2.2[101,150] 100mb                 |L2.2-|                                                         "
    - "L2.3[151,200] 70mb                          |L2.3-|                                                 "
    - "L2.10[1,72] 100.23mb|--L2.10--|                                                                     "
    - "L2.11[73,100] 39.53mb           |L2.11|                                                              "
    "###
    );
}
...
async fn many_l1_overlaps_with_many_l2s() {
    ...
    - "L2                                                                                                  "
    - "L2.?[51,91] 101.82mb|-------------L2.?-------------|                                                "
    - "L2.?[92,131] 99.27mb                                 |------------L2.?-------------|                "
    - "L2.?[132,150] 50.91mb                                                                 |----L2.?----| "
    - "Committing partition 1:"
    ...
    - "L2                                                                                                  "
    - "L2.3[151,200] 70mb                                                  |--------L2.3---------|         "
    - "L2.14[51,91] 101.82mb|------L2.14------|                                                             "
    - "L2.15[92,131] 99.27mb                    |------L2.15------|                                         "
    - "L2.16[132,150] 50.91mb                                       |L2.16-|                                 "
    "###
    );
}
...
async fn many_good_size_l0_files() {
    ...
    - "L0                                                                                                  "
    - "L0.296[282,288] 14mb                                                                           |L0.296|"
    - "L0.295[256,281] 50mb                                                        |-----L0.295-----|      "
    - "L0.294[229,256] 58mb                                    |-----L0.294------|                         "
    - "L0.293[179,228] 98mb|-------------L0.293--------------|                                             "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 220mb total:"
    - "L1                                                                                                  "
    - "L1.?[179,229] 100.92mb|---------------L1.?---------------|                                            "
    - "L1.?[230,279] 98.9mb                                     |--------------L1.?---------------|        "
    - "L1.?[280,288] 20.18mb                                                                          |L1.?|"
    - "Committing partition 1:"
    ...
    - "L1                                                                                                  "
    - "L1.299[280,288] 20.18mb                                                                    |-L1.299--| "
    - "L1.298[230,279] 98.9mb|-----------------------------L1.298------------------------------|             "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 119.08mb total:"
    - "L2                                                                                                  "
    - "L2.?[230,276] 94.44mb|----------------------------L2.?-----------------------------|                 "
    - "L2.?[277,288] 24.64mb                                                                |----L2.?-----| "
    - "Committing partition 1:"
    ...
    - "L2.297[179,229] 100.92mb                                                 |--L2.297---|                  "
    - "L2.300[51,101] 100.79mb              |--L2.300---|                                                     "
    - "L2.303[102,151] 100.07mb                            |--L2.303---|                                       "
    - "L2.304[152,178] 55.14mb                                          |L2.304|                              "
    - "L2.305[230,276] 94.44mb                                                               |--L2.305--|     "
    - "L2.306[277,288] 24.64mb                                                                            |L2.306|"
    "###
    );
}
