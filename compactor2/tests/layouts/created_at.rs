...
async fn base1_level1_level2_overlaps() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[6]). 3 Input Files, 200mb total:"
    - "L1                                                                                                                 "
    - "L1.3[6,10] 10ns 50mb                                                       |-----------------L1.3-----------------|"
    - "L1.2[1,5] 8ns 50mb       |-----------------L1.2-----------------|                                                  "
    - "L2                                                                                                                 "
...
async fn base1_level0_level1() {
    ...
    - "L2                                                                                                                 "
    - "L2.1[4,7] 7ns 100mb                                    |------------L2.1------------|                              "
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[4]). 2 Input Files, 100mb total:"
    - "L0, all files 50mb                                                                                                 "
    - "L0.4[2,4] 11ns                                 |-------------------L0.4--------------------|                       "
    - "L1, all files 50mb                                                                                                 "
    - "L1.2[1,5] 8ns            |------------------------------------------L1.2------------------------------------------|"
    ...
    - "  Creating 2 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[5, 9]). 4 Input Files, 250mb total:"
    - "L1                                                                                                                 "
    - "L1.3[6,10] 10ns 50mb                                                       |-----------------L1.3-----------------|"
    - "L1.6[5,5] 11ns 25mb                                              |L1.6|                                            "
    - "L1.5[1,4] 11ns 75mb      |------------L1.5------------|                                                            "
    - "L2                                                                                                                 "
    - "L2.1[4,7] 7ns 100mb                                    |------------L2.1------------|                              "
