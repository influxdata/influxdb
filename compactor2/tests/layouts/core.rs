...
async fn all_non_overlapping_l0() {
    ...
    - "L0.2[100,101] 1ns                 |L0.2|                                                                           "
    - "L0.1[0,1] 1ns            |L0.1|                                                                                    "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 99.89mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,720] 1ns 79.91mb  |--------------------------------L1.?---------------------------------|                   "
    - "L1.?[721,901] 1ns 19.98mb                                                                        |-----L1.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 10 files: L0.1, L0.2, L0.3, L0.4, L0.5, L0.6, L0.7, L0.8, L0.9, L0.10"
    - "  Creating 2 files at level CompactionLevel::L1"
    - "**** Final Output Files "
    ...
    - "L1.12[721,901] 1ns 19.98mb                                                                        |-----L1.12-----| "
    "###
    );
}
...
async fn l1_with_non_overlapping_l0_larger() {
    ...
    - "**** 2 Output Files (parquet_file_id not yet assigned), 107.73mb total:"
    - "L2                                                                                                                 "
    - "L2.?[50,370] 1ns 86.4mb  |---------------------------------L2.?---------------------------------|                  "
    - "L2.?[371,450] 1ns 21.33mb                                                                        |-----L2.?------| "
    - "Committing partition 1:"
    ...
    - "L2.10[371,450] 1ns 21.33mb                                                                        |-----L2.10-----| "
    "###
    );
}
...
async fn many_l1_with_non_overlapping_l0() {
    ...
    - "**** 2 Output Files (parquet_file_id not yet assigned), 87.85mb total:"
    - "L2                                                                                                                 "
    - "L2.?[50,530] 1ns 70.4mb  |---------------------------------L2.?---------------------------------|                  "
    - "L2.?[531,650] 1ns 17.45mb                                                                        |-----L2.?------| "
    - "Committing partition 1:"
    ...
    - "L2.16[531,650] 1ns 17.45mb                                                                        |-----L2.16-----| "
    "###
    );
}
...
async fn large_l1_with_non_overlapping_l0() {
    ...
    - "**** 2 Output Files (parquet_file_id not yet assigned), 184.69mb total:"
    - "L2                                                                                                                 "
    - "L2.?[50,375] 1ns 100.21mb|---------------------L2.?---------------------|                                          "
    - "L2.?[376,650] 1ns 84.48mb                                                |-----------------L2.?------------------| "
    - "Committing partition 1:"
