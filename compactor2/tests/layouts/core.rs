...
async fn all_overlapping_l0() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[160020]). 10 Input Files, 90mb total:"
    - "L0, all files 9mb                                                                                                  "
    - "L0.10[100,200000] 10ns   |-----------------------------------------L0.10-----------------------------------------| "
    - "L0.9[100,200000] 9ns     |-----------------------------------------L0.9------------------------------------------| "
    - "L0.8[100,200000] 8ns     |-----------------------------------------L0.8------------------------------------------| "
...
async fn all_non_overlapping_l0() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[720]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.10[900,901] 9ns                                                                                                |L0.10|"
    - "L0.9[800,801] 8ns                                                                                       |L0.9|     "
    - "L0.8[700,701] 7ns                                                                             |L0.8|               "
    ...
    - "  Soft Deleting 10 files: L0.1, L0.2, L0.3, L0.4, L0.5, L0.6, L0.7, L0.8, L0.9, L0.10"
    - "  Creating 2 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[720]). 2 Input Files, 100mb total:"
    - "L1                                                                                                                 "
...
async fn l1_with_non_overlapping_l0_larger() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[370]). 5 Input Files, 108mb total:"
    - "L1                                                                                                                 "
    - "L1.4[200,249] 4ns 3mb                                     |--L1.4---|                                              "
    - "L1.3[150,199] 3ns 20mb                         |--L1.3---|                                                         "
    - "L1.2[100,149] 2ns 50mb              |--L1.2---|                                                                    "
...
async fn l1_too_much_with_non_overlapping_l0() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[113, 176]). 3 Input Files, 240mb total:"
    - "L1                                                                                                                 "
    - "L1.1[50,99] 0ns 90mb     |-----------L1.1------------|                                                             "
    - "L1.2[100,149] 60s 80mb                                 |-----------L1.2------------|                               "
    - "L1.3[150,199] 120s 70mb                                                              |-----------L1.3------------| "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[272, 344]). 4 Input Files, 280mb total:"
    - "L1, all files 70mb                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 3, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[511, 622]). 4 Input Files, 225mb total:"
    - "L1                                                                                                                 "
...
async fn many_l1_with_non_overlapping_l0() {
    ...
    - "  Soft Deleting 3 files: L0.11, L0.12, L0.13"
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[530]). 11 Input Files, 88mb total:"
    - "L1                                                                                                                 "
    - "L1.10[500,549] 10ns 7mb                                                                     |L1.10|                "
    - "L1.9[450,499] 9ns 7mb                                                                |L1.9-|                       "
    - "L1.8[400,449] 8ns 7mb                                                        |L1.8-|                               "
...
async fn large_l1_with_non_overlapping_l0() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[375]). 3 Input Files, 185mb total:"
    - "L1                                                                                                                 "
    - "L1.2[100,149] 2ns 80mb          |L1.2-|                                                                            "
    - "L1.1[50,99] 1ns 90mb     |L1.1-|                                                                                   "
