...
async fn test_keep_ingesting_l0_files_40_percent_overlap_l1_left() {
    ...
    for i in 0..n {
        ...
        if i == show_intermediate_result_runs[0] {
            ...
            - "L0.4[30,44] 3ns                                                            |--------L0.4---------|                 "
            - "L0.5[40,54] 4ns                                                                            |--------L0.5---------| "
            - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[43]). 5 Input Files, 25mb total:"
            - "L0, all files 5mb                                                                                                  "
            - "L0.5[40,54] 4ns                                                                            |--------L0.5---------| "
            - "L0.4[30,44] 3ns                                                            |--------L0.4---------|                 "
            - "L0.3[20,34] 2ns                                           |--------L0.3---------|                                  "
            ...
            - "**** Simulation run 35, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[1443]). 5 Input Files, 25mb total:"
            - "L0, all files 5mb                                                                                                  "
            ...
            - "**** Simulation run 56, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[2292]). 6 Input Files, 30.09mb total:"
            - "L0                                                                                                                 "
            - "L0.342[2290,2304] 229ns 5mb                                                                     |------L0.342-------|"
            - "L0.341[2280,2294] 228ns 5mb                                                      |------L0.341-------|               "
            - "L0.340[2270,2284] 227ns 5mb                                       |------L0.340-------|                              "
            ...
            - "**** Simulation run 83, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[3391]). 6 Input Files, 31.61mb total:"
            - "L0                                                                                                                 "
            - "L0.506[3390,3404] 339ns 5mb                                                                     |------L0.506------| "
            - "L0.505[3380,3394] 338ns 5mb                                                       |------L0.505------|               "
            - "L0.504[3370,3384] 337ns 5mb                                        |------L0.504------|                              "
            ...
            - "  Creating 2 files"
            - "**** Simulation run 84, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[3362]). 6 Input Files, 121.11mb total:"
            - "L1                                                                                                                 "
            - "L1.500[3293,3341] 334ns 24.41mb                                                |----L1.500-----|                         "
            - "L1.493[3244,3292] 329ns 24.07mb                              |----L1.493-----|                                           "
            - "L1.486[3200,3243] 324ns 19.91mb             |----L1.486----|                                                             "
            ...
            - "**** Simulation run 111, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[4492]). 6 Input Files, 30.09mb total:"
            - "L0                                                                                                                 "
            - "L0.672[4490,4504] 449ns 5mb                                                                     |------L0.672-------|"
            - "L0.671[4480,4494] 448ns 5mb                                                      |------L0.671-------|               "
            - "L0.670[4470,4484] 447ns 5mb                                       |------L0.670-------|                              "
            ...
            - "**** Simulation run 123, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[4991]). 6 Input Files, 31.61mb total:"
            - "L0                                                                                                                 "
            - "L0.746[4990,5004] 499ns 5mb                                                                     |------L0.746------| "
            - "L0.745[4980,4994] 498ns 5mb                                                       |------L0.745------|               "
            - "L0.744[4970,4984] 497ns 5mb                                        |------L0.744------|                              "
            ...
            - "  Creating 2 files"
            - "**** Simulation run 124, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[4962]). 6 Input Files, 121.11mb total:"
            - "L1                                                                                                                 "
            - "L1.740[4893,4941] 494ns 24.41mb                                                |----L1.740-----|                         "
            - "L1.733[4844,4892] 489ns 24.07mb                              |----L1.733-----|                                           "
            - "L1.726[4800,4843] 484ns 19.91mb             |----L1.726----|                                                             "
