...
async fn two_large_files_total_over_max_compact_size_start_l0() {
    ...
    - "**** Simulation run 0, type=split(split_times=[333, 666]). 1 Input Files, 150mb total:"
    - "L0, all files 150mb                                                                                                "
    - "L0.1[0,1000] 10ns        |------------------------------------------L0.1------------------------------------------|"
    ...
    - "**** Simulation run 1, type=split(split_times=[333, 666]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.2[1,1000] 9ns         |------------------------------------------L1.2------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
    ...
    - "  Creating 6 files"
    - "**** Simulation run 2, type=split(split_times=[667]). 4 Input Files, 200.2mb total:"
    - "L0                                                                                                                 "
    - "L0.5[667,1000] 10ns 50.25mb                                             |-------------------L0.5--------------------|"
    - "L0.4[334,666] 10ns 49.8mb|-------------------L0.4-------------------|                                              "
    - "L1                                                                                                                 "
    - "L1.8[667,1000] 9ns 50.3mb                                             |-------------------L1.8--------------------|"
    - "L1.7[334,666] 9ns 49.85mb|-------------------L1.7-------------------|                                              "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 200.2mb total:"
    - "L1                                                                                                                 "
    - "L1.?[334,667] 10ns 100.1mb|-------------------L1.?--------------------|                                             "
    - "L1.?[668,1000] 10ns 100.1mb                                             |-------------------L1.?-------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L0.4, L0.5, L1.7, L1.8"
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(split_times=[266]). 2 Input Files, 99.8mb total:"
    - "L0                                                                                                                 "
    - "L0.3[0,333] 10ns 49.95mb |------------------------------------------L0.3------------------------------------------|"
    - "L1                                                                                                                 "
    - "L1.6[1,333] 9ns 49.85mb  |-----------------------------------------L1.6------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 99.8mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,266] 10ns 79.72mb |--------------------------------L1.?---------------------------------|                   "
    - "L1.?[267,333] 10ns 20.08mb                                                                        |-----L1.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.3, L1.6"
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(split_times=[266]). 2 Input Files, 99.8mb total:"
    - "L1                                                                                                                 "
