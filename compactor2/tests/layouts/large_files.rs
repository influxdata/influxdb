...
async fn two_large_files_total_over_max_compact_size_start_l0() {
    ...
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[933]). 2 Input Files, 99.95mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[334]). 2 Input Files, 200.05mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[668]). 3 Input Files, 199.83mb total:"
    - "L1                                                                                                                 "
