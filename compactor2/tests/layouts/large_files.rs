...
async fn two_large_files_total_under_max_compact_size() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[501]). 2 Input Files, 200mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.1[1,1000] 9ns         |------------------------------------------L1.1------------------------------------------|"
    - "L2, all files 100mb                                                                                                "
    - "L2.2[2,1000] 8ns         |-----------------------------------------L2.2------------------------------------------| "
...
async fn two_large_files_total_over_max_compact_size() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[667]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.1[1,1000] 9ns         |------------------------------------------L1.1------------------------------------------|"
    ...
    - "**** Simulation run 1, type=split(FoundFilesToSplit)(split_times=[668]). 1 Input Files, 150mb total:"
    - "L2, all files 150mb                                                                                                "
    - "L2.2[2,1000] 8ns         |------------------------------------------L2.2------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L2                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[335]). 3 Input Files, 200.1mb total:"
    - "L1                                                                                                                 "
...
async fn two_large_files_total_over_max_compact_size_small_overlap_range() {
    ...
    - "**** Simulation run 1, type=split(FoundFilesToSplit)(split_times=[934]). 1 Input Files, 150mb total:"
    - "L2, all files 150mb                                                                                                "
    - "L2.2[800,1000] 8ns       |------------------------------------------L2.2------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L2                                                                                                                 "
    ...
    - "  Soft Deleting 2 files: L1.1, L2.2"
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[835]). 3 Input Files, 199.95mb total:"
    - "L1                                                                                                                 "
...
async fn two_large_files_total_over_max_compact_size_small_overlap_range_2() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[1600]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.1[800,2000] 9ns       |------------------------------------------L1.1------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
    ...
    - "**** Simulation run 1, type=split(FoundFilesToSplit)(split_times=[2534]). 1 Input Files, 150mb total:"
    - "L2, all files 150mb                                                                                                "
    - "L2.2[1600,3000] 8ns      |------------------------------------------L2.2------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L2                                                                                                                 "
    ...
    - "  Soft Deleting 2 files: L1.1, L2.2"
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[1494, 2188]). 3 Input Files, 250.07mb total:"
    - "L1                                                                                                                 "
...
async fn two_large_files_total_over_max_compact_size_small_overlap_range_3() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[200]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.1[0,300] 9ns          |------------------------------------------L1.1------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
    ...
    - "  Soft Deleting 2 files: L1.1, L2.2"
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[374, 748]). 3 Input Files, 250.09mb total:"
    - "L1                                                                                                                 "
...
async fn two_large_files_total_over_max_compact_size_start_l0() {
    ...
    - "**** Simulation run 1, type=split(FoundFilesToSplit)(split_times=[667]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.2[1,1000] 9ns         |------------------------------------------L1.2------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
    ...
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[933]). 2 Input Files, 99.95mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[334]). 2 Input Files, 200.05mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[668]). 3 Input Files, 199.83mb total:"
    - "L1                                                                                                                 "
...
async fn target_too_large_1() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[396, 791]). 1 Input Files, 253mb total:"
    - "L2, all files 253mb                                                                                                "
    - "L2.1[1,1000] 5ns         |------------------------------------------L2.1------------------------------------------|"
    ...
    - "  Creating 3 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[328, 655]). 4 Input Files, 241.68mb total:"
    - "L1                                                                                                                 "
...
async fn target_too_large_2() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[1294, 2587]). 1 Input Files, 232mb total:"
    - "L2, all files 232mb                                                                                                "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[705]). 3 Input Files, 183.69mb total:"
    - "L1                                                                                                                 "
    - "L1.2[1,1000] 10ns 69mb   |-------------------------------L1.2--------------------------------|                     "
...
async fn start_too_large_similar_time_range() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[401, 801]). 1 Input Files, 250mb total:"
    - "L1, all files 250mb                                                                                                "
    - "L1.1[1,1000] 9ns         |------------------------------------------L1.1------------------------------------------|"
    ...
    - "  Creating 3 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[398, 795]). 3 Input Files, 251.95mb total:"
    - "L1                                                                                                                 "
...
async fn start_too_large_small_time_range() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[400, 800]). 1 Input Files, 250mb total:"
    - "L1, all files 250mb                                                                                                "
    - "L1.1[0,1000] 9ns         |------------------------------------------L1.1------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 250mb total:"
    - "L1                                                                                                                 "
    ...
    - "  Soft Deleting 1 files: L1.1"
    - "  Creating 3 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[698, 995]). 3 Input Files, 202mb total:"
    - "L1                                                                                                                 "
...
async fn start_too_large_small_time_range_2() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[1280, 1760]). 1 Input Files, 250mb total:"
    - "L1, all files 250mb                                                                                                "
    ...
    - "  Soft Deleting 1 files: L1.1"
    - "  Creating 3 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[2132, 2983]). 3 Input Files, 202mb total:"
    - "L1                                                                                                                 "
...
async fn start_too_large_small_time_range_3() {
    ...
    - "**** Simulation run 0, type=split(FoundFilesToSplit)(split_times=[120, 240]). 1 Input Files, 250mb total:"
    - "L1, all files 250mb                                                                                                "
    - "L1.1[0,300] 9ns          |------------------------------------------L1.1------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 250mb total:"
    - "L1                                                                                                                 "
    ...
    - "  Soft Deleting 1 files: L1.1"
    - "  Creating 3 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[705, 1289]). 3 Input Files, 202mb total:"
    - "L1                                                                                                                 "
