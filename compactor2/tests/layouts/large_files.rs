...
async fn two_large_files_total_over_max_compact_size_start_l0() {
    ...
    - "**** Simulation run 0, type=split(HighL0Overlap)(split_times=[333, 666]). 1 Input Files, 150mb total:"
    - "L0, all files 150mb                                                                                                "
    - "L0.1[0,1000] 10ns        |------------------------------------------L0.1------------------------------------------|"
    ...
    - "**** Simulation run 1, type=split(HighL0Overlap)(split_times=[333, 666]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.2[1,1000] 9ns         |------------------------------------------L1.2------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
