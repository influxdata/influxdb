...
async fn two_large_files_total_over_max_compact_size_start_l0() {
    ...
    - "**** Simulation run 0, type=split(split_times=[500]). 1 Input Files, 150mb total:"
    - "L0, all files 150mb                                                                                                "
    - "L0.1[0,1000] 10ns        |------------------------------------------L0.1------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L0, all files 75mb                                                                                                 "
    - "L0.?[0,500] 10ns         |-------------------L0.?--------------------|                                             "
    - "L0.?[501,1000] 10ns                                                   |-------------------L0.?-------------------| "
    - "**** Simulation run 1, type=split(split_times=[500]). 1 Input Files, 150mb total:"
    - "L1, all files 150mb                                                                                                "
    - "L1.2[1,1000] 9ns         |------------------------------------------L1.2------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150mb total:"
    - "L1                                                                                                                 "
    - "L1.?[1,500] 9ns 74.92mb  |-------------------L1.?-------------------|                                              "
    - "L1.?[501,1000] 9ns 75.08mb                                             |-------------------L1.?-------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.1, L1.2"
    - "  Creating 4 files"
    - "**** Simulation run 2, type=split(split_times=[834]). 2 Input Files, 150.08mb total:"
    - "L0                                                                                                                 "
    - "L0.4[501,1000] 10ns 75mb |------------------------------------------L0.4------------------------------------------|"
    - "L1                                                                                                                 "
    - "L1.6[501,1000] 9ns 75.08mb|------------------------------------------L1.6------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 150.08mb total:"
    - "L1                                                                                                                 "
    - "L1.?[501,834] 10ns 100.15mb|---------------------------L1.?---------------------------|                              "
    - "L1.?[835,1000] 10ns 49.92mb                                                            |-----------L1.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.4, L1.6"
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(split_times=[334]). 2 Input Files, 149.92mb total:"
    - "L0                                                                                                                 "
    - "L0.3[0,500] 10ns 75mb    |------------------------------------------L0.3------------------------------------------|"
    - "L1                                                                                                                 "
    - "L1.5[1,500] 9ns 74.92mb  |-----------------------------------------L1.5------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 149.92mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,334] 10ns 100.15mb|---------------------------L1.?---------------------------|                              "
    - "L1.?[335,500] 10ns 49.78mb                                                            |-----------L1.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.3, L1.5"
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(split_times=[668]). 3 Input Files, 199.85mb total:"
    - "L1                                                                                                                 "
    - "L1.8[835,1000] 10ns 49.92mb                                                                   |--------L1.8--------| "
    - "L1.10[335,500] 10ns 49.78mb|-------L1.10--------|                                                                    "
    - "L1.7[501,834] 10ns 100.15mb                      |-------------------L1.7--------------------|                       "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 199.85mb total:"
    - "L2                                                                                                                 "
    - "L2.?[335,668] 10ns 100.08mb|-------------------L2.?--------------------|                                             "
    - "L2.?[669,1000] 10ns 99.77mb                                             |-------------------L2.?-------------------| "
    - "Committing partition 1:"
    ...
    - "**** Final Output Files "
    - "L2                                                                                                                 "
    - "L2.9[0,334] 10ns 100.15mb|------------L2.9------------|                                                            "
    - "L2.11[335,668] 10ns 100.08mb                              |-----------L2.11-----------|                               "
    - "L2.12[669,1000] 10ns 99.77mb                                                            |-----------L2.12-----------| "
    "###
    );
