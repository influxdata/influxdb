...
async fn random_backfill_empty_partition() {
    ...
    - "  Creating 2 files"
    - "**** Simulation run 5, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[357, 672]). 6 Input Files, 300mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 6 files"
    - "**** Simulation run 8, type=split(CompactAndSplitOutput(ManySmallFiles))(split_times=[514]). 8 Input Files, 200mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 4 files"
    - "**** Simulation run 11, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[253, 464]). 4 Input Files, 299.89mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 12, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[639, 813]). 4 Input Files, 299.59mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 13, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[441, 628]). 3 Input Files, 299.5mb total:"
    - "L1                                                                                                                 "
