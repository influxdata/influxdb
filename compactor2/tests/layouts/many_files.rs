...
async fn many_l1_files() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[20]). 20 Input Files, 203mb total:"
    - "L1                                                                                                                 "
    - "L1.14[26,27] 14ns 10mb                                                               |L1.14|                       "
    - "L1.15[28,29] 15ns 10mb                                                                   |L1.15|                   "
    - "L1.16[30,31] 16ns 10mb                                                                        |L1.16|              "
...
async fn many_l0_and_overlapped_l1_files() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[159]). 21 Input Files, 21.3mb total:"
    - "L0                                                                                                                 "
...
async fn not_many_l0_and_overlapped_l1_files() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[2407]). 16 Input Files, 21.3mb total:"
    - "L1                                                                                                                 "
    - "L1.196[200,209] 6ns 1mb       |L1.196|                                                                             "
    - "L1.197[400,409] 7ns 1mb             |L1.197|                                                                       "
    - "L1.198[600,609] 8ns 1mb                   |L1.198|                                                                 "
...
async fn random_backfill_empty_partition() {
    ...
    - "**** Simulation run 0, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[797]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.1[76,932] 1us            |-------------------------------------L0.1--------------------------------------|      "
    - "L0.2[42,986] 1us         |------------------------------------------L0.2------------------------------------------|"
    - "L0.3[173,950] 1us                    |----------------------------------L0.3----------------------------------|    "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 1, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[797]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.11[173,950] 1.01us                |---------------------------------L0.11----------------------------------|    "
    - "L0.12[50,629] 1.01us     |------------------------L0.12------------------------|                                   "
    - "L0.13[76,932] 1.01us        |-------------------------------------L0.13-------------------------------------|      "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 2, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[797]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.21[76,932] 1.02us        |-------------------------------------L0.21-------------------------------------|      "
    - "L0.22[42,986] 1.02us     |-----------------------------------------L0.22------------------------------------------|"
    - "L0.23[173,950] 1.02us                |---------------------------------L0.23----------------------------------|    "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 3, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[797]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.31[173,950] 1.03us                |---------------------------------L0.31----------------------------------|    "
    - "L0.32[50,629] 1.03us     |------------------------L0.32------------------------|                                   "
    - "L0.33[76,932] 1.03us        |-------------------------------------L0.33-------------------------------------|      "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 4, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[797]). 10 Input Files, 100mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.41[76,932] 1.04us        |-------------------------------------L0.41-------------------------------------|      "
    - "L0.42[42,986] 1.04us     |-----------------------------------------L0.42------------------------------------------|"
    - "L0.43[173,950] 1.04us                |---------------------------------L0.43----------------------------------|    "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 5, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[357, 672]). 6 Input Files, 300mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 6, type=split(ReduceOverlap)(split_times=[357, 672]). 1 Input Files, 79.98mb total:"
    ...
    - "**** Simulation run 7, type=split(ReduceOverlap)(split_times=[357, 672]). 1 Input Files, 79.98mb total:"
    - "L0, all files 79.98mb                                                                                              "
    ...
    - "  Creating 6 files"
    - "**** Simulation run 8, type=split(TriedToCompactTooMuch(ManySmallFiles))(split_times=[514]). 8 Input Files, 200mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 9, type=split(ReduceOverlap)(split_times=[672]). 1 Input Files, 100mb total:"
    - "L0, all files 100mb                                                                                                "
    ...
    - "**** Simulation run 10, type=split(ReduceOverlap)(split_times=[357]). 1 Input Files, 100mb total:"
    - "L0, all files 100mb                                                                                                "
    ...
    - "  Creating 4 files"
    - "**** Simulation run 11, type=split(TriedToCompactTooMuch(FoundSubsetLessThanMaxCompactSize))(split_times=[253, 464]). 4 Input Files, 299.89mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 12, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[639, 813]). 4 Input Files, 299.59mb total:"
    - "L0                                                                                                                 "
    ...
    - "  Creating 3 files"
    - "**** Simulation run 13, type=split(TriedToCompactTooMuch(TotalSizeLessThanMaxCompactSize))(split_times=[441, 628]). 3 Input Files, 299.5mb total:"
    - "L1                                                                                                                 "
