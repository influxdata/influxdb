...
const (
	...
	Command_DeleteShardCommand               Command_Type = 30
)
...
func (m *DeleteShardCommand) Reset()         { *m = DeleteShardCommand{} }
func (m *DeleteShardCommand) String() string { return proto.CompactTextString(m) }
func (*DeleteShardCommand) ProtoMessage()    {}

func (m *DeleteShardCommand) GetID() uint64 {
	if m != nil && m.ID != nil {
		return *m.ID
	}
	return 0
...
var E_DeleteShardCommand_Command = &proto.ExtensionDesc{
	ExtendedType:  (*Command)(nil),
	ExtensionType: (*DeleteShardCommand)(nil),
	Field:         130,
	Name:          "internal.DeleteShardCommand.command",
...
func init() {
	...
	proto.RegisterType((*DeleteShardCommand)(nil), "internal.DeleteShardCommand")
	...
	proto.RegisterExtension(E_DeleteShardCommand_Command)
}
