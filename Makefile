...
bindata:
	...
	go-bindata -o canned/apps_gen.go -ignore 'go' -pkg canned -prefix canned canned/...

dev-bindata:
	go-bindata -debug -o dist/dist_gen.go -ignore 'map|go' -pkg dist ui/build/...
	go-bindata -debug -o canned/apps_gen.go -ignore 'go' -pkg canned -prefix canned canned/...
