...
The `test.sh` script executes a test suite with 5 variants (standard 64 bit, 64 bit with race detection, 32 bit, TSI), each executes with a different arg, 0 through 3. Unless you know differently, `./test.sh 0` is probably all you need.
