...
pub(crate) struct TelemetryPayload {
    ...
    pub uptime_secs: u64,
    // cpu
    pub cpu_utilization_percent_min_hourly: f32,
    pub cpu_utilization_percent_max_hourly: f32,
    pub cpu_utilization_percent_avg_hourly: f32,
    // mem
    pub memory_used_mb_min_hourly: u64,
    pub memory_used_mb_max_hourly: u64,
    pub memory_used_mb_avg_hourly: u64,
    // writes
    pub write_requests_min_hourly: u64,
    pub write_requests_max_hourly: u64,
    pub write_requests_avg_hourly: u64,

    pub write_lines_min_hourly: u64,
    pub write_lines_max_hourly: u64,
    pub write_lines_avg_hourly: u64,

    pub write_mb_min_hourly: u64,
    pub write_mb_max_hourly: u64,
    pub write_mb_avg_hourly: u64,
    // reads
    pub query_requests_min_hourly: u64,
    pub query_requests_max_hourly: u64,
    pub query_requests_avg_hourly: u64,
    // parquet files
...
mod tests {
    ...
    fn create_sample_payload() -> TelemetryPayload {
        TelemetryPayload {
            ...
            cores: 10,
            product_type: "OSS",
            cpu_utilization_percent_min_hourly: 100.0,
            cpu_utilization_percent_max_hourly: 100.0,
            cpu_utilization_percent_avg_hourly: 100.0,
            memory_used_mb_min_hourly: 250,
            memory_used_mb_max_hourly: 250,
            memory_used_mb_avg_hourly: 250,
            write_requests_min_hourly: 100,
            write_requests_max_hourly: 100,
            write_requests_avg_hourly: 100,
            write_lines_min_hourly: 200_000,
            write_lines_max_hourly: 200_000,
            write_lines_avg_hourly: 200_000,
            write_mb_min_hourly: 15,
            write_mb_max_hourly: 15,
            write_mb_avg_hourly: 15,
            query_requests_min_hourly: 15,
            query_requests_max_hourly: 15,
            query_requests_avg_hourly: 15,
