			...
			fields: NotificationEndpointFields{
				...
				NotificationEndpoints: []influxdb.NotificationEndpoint{
					...
					&endpoint.PagerDuty{
						...
						ClientURL:  "https://example-pagerduty.com",
						RoutingKey: influxdb.SecretField{Key: fmt.Sprintf("%s-routing-key", fourID)},
					},
					&endpoint.PagerDuty{
						Base: endpoint.Base{
			...
			fields: NotificationEndpointFields{
				...
				NotificationEndpoints: []influxdb.NotificationEndpoint{
					...
					&endpoint.PagerDuty{
						...
						ClientURL: "https://example-pagerduty.com", RoutingKey: influxdb.SecretField{Key: fmt.Sprintf("%s-routing-key", threeID)},
					},
				},
			},
			args: args{
