...
func (m *MockRestoreService) RestoreBucket(ctx context.Context, id platform.ID, rpiData []byte, replace bool) (map[uint64]uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestoreBucket", ctx, id, rpiData, replace)
...
func (mr *MockRestoreServiceMockRecorder) RestoreBucket(ctx, id, rpiData, replace interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestoreBucket", reflect.TypeOf((*MockRestoreService)(nil).RestoreBucket), ctx, id, rpiData, replace)
}
