...
type CapabilitiesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Caps          map[string]string      `protobuf:"bytes,1,rep,name=caps,proto3" json:"caps,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadResponse_Frame) GetMultiPoints() *ReadResponse_MultiPointsFrame {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_Frame_MultiPoints); ok {
...
func (x *ReadResponse_AnyPoints) GetData() isReadResponse_AnyPoints_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ReadResponse_AnyPoints) GetFloats() *ReadResponse_FloatValues {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_AnyPoints_Floats); ok {
			return x.Floats
		}
	}
	return nil
...
func (x *ReadResponse_AnyPoints) GetIntegers() *ReadResponse_IntegerValues {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_AnyPoints_Integers); ok {
			return x.Integers
		}
	}
	return nil
...
func (x *ReadResponse_AnyPoints) GetUnsigneds() *ReadResponse_UnsignedValues {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_AnyPoints_Unsigneds); ok {
			return x.Unsigneds
		}
	}
	return nil
...
func (x *ReadResponse_AnyPoints) GetBooleans() *ReadResponse_BooleanValues {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_AnyPoints_Booleans); ok {
			return x.Booleans
		}
	}
	return nil
...
func (x *ReadResponse_AnyPoints) GetStrings() *ReadResponse_StringValues {
	if x != nil {
		if x, ok := x.Data.(*ReadResponse_AnyPoints_Strings); ok {
			return x.Strings
		}
	}
	return nil
...
const file_storage_common_proto_rawDesc = "" +
	...
	"\fCapabilities\x12\x16.google.protobuf.Empty\x1a1.influxdata.platform.storage.CapabilitiesResponseB\rZ\v.;datatypesb\x06proto3"
...
func file_storage_common_proto_init() {
	...
	file_storage_common_proto_msgTypes[13].OneofWrappers = []any{
	...
	file_storage_common_proto_msgTypes[21].OneofWrappers = []any{
