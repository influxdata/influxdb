	...
	tests := []struct {
	...
	}{
		{
			...
			expected: &Config{
				...
				EmailMaxRetries:      3,
				PrivateKey:           "projects/influxdata-v3-pro-licensing/locations/global/keyRings/pro-licensing/cryptoKeys/signing-key-1/cryptoKeyVersions/1",
				PublicKey:            "gcloud-kms_global_pro-licensing_signing-key-1_v1.pem",
