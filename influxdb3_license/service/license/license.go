...
var (
	...
	ErrHostIDEmpty     = errors.New("host ID cannot be empty")
...
func (c *Creator) Create(email, hostID, instanceID string, d time.Duration) (string, error) {
	// Validate input
	if email == "" {
		return "", ErrEmailEmpty
	} else if hostID == "" {
		return "", ErrHostIDEmpty
	} else if instanceID == "" {
