...
func TestSelect(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			q:    `SELECT exp_moving_average(value, 3) FROM cpu WHERE time >= '1970-01-01T00:00:00Z' AND time < '1970-01-01T00:00:16Z'`,
			typ:  influxql.Float,
			itrs: []query.Iterator{
				&FloatIterator{Points: []query.FloatPoint{
					{Name: "cpu", Time: 0 * Second, Value: 0},
					{Name: "cpu", Time: 1 * Second, Value: 0},
					{Name: "cpu", Time: 2 * Second, Value: 0},
					{Name: "cpu", Time: 3 * Second, Value: 0},
					{Name: "cpu", Time: 4 * Second, Value: 0},
					{Name: "cpu", Time: 5 * Second, Value: 0},
					{Name: "cpu", Time: 6 * Second, Value: 0},
					{Name: "cpu", Time: 7 * Second, Value: 0},
					{Name: "cpu", Time: 8 * Second, Value: 0},
					{Name: "cpu", Time: 9 * Second, Value: 0},
					{Name: "cpu", Time: 10 * Second, Value: 64},
					{Name: "cpu", Time: 11 * Second, Value: 32},
					{Name: "cpu", Time: 12 * Second, Value: 16},
					{Name: "cpu", Time: 13 * Second, Value: 8},
					{Name: "cpu", Time: 14 * Second, Value: 4},
					{Name: "cpu", Time: 15 * Second, Value: 2},
				}},
			},
			points: [][]query.Point{
				{&query.FloatPoint{Name: "cpu", Time: 10 * Second, Aggregated: 11, Value: 32}},
				{&query.FloatPoint{Name: "cpu", Time: 11 * Second, Aggregated: 12, Value: 32}},
				{&query.FloatPoint{Name: "cpu", Time: 12 * Second, Aggregated: 13, Value: 24}},
				{&query.FloatPoint{Name: "cpu", Time: 13 * Second, Aggregated: 14, Value: 16}},
				{&query.FloatPoint{Name: "cpu", Time: 14 * Second, Aggregated: 15, Value: 10}},
				{&query.FloatPoint{Name: "cpu", Time: 15 * Second, Aggregated: 16, Value: 6}},
			},
		},
		{
			name: "ExponentialMovingAverage_Integer",
			q:    `SELECT exp_moving_average(value, 3) FROM cpu WHERE time >= '1970-01-01T00:00:00Z' AND time < '1970-01-01T00:00:16Z'`,
			typ:  influxql.Integer,
			itrs: []query.Iterator{
				&IntegerIterator{Points: []query.IntegerPoint{
