...
func newExponentialMovingAverageIterator(input Iterator, n int, nHold int, warmupType string, opt IteratorOptions) (Iterator, error) {
	switch input := input.(type) {
	case FloatIterator:
		createFn := func() (FloatPointAggregator, FloatPointEmitter) {
...
func newDoubleExponentialMovingAverageIterator(input Iterator, n int, nHold int, warmupType string, opt IteratorOptions) (Iterator, error) {
	switch input := input.(type) {
	case FloatIterator:
		createFn := func() (FloatPointAggregator, FloatPointEmitter) {
...
func newTripleExponentialMovingAverageIterator(input Iterator, n int, nHold int, warmupType string, opt IteratorOptions) (Iterator, error) {
	switch input := input.(type) {
	case FloatIterator:
		createFn := func() (FloatPointAggregator, FloatPointEmitter) {
...
func newTripleExponentialAverageIterator(input Iterator, n int, nHold int, warmupType string, opt IteratorOptions) (Iterator, error) {
	switch input := input.(type) {
	case FloatIterator:
		createFn := func() (FloatPointAggregator, FloatPointEmitter) {
