...
//! the `inventory` crate. `#[catalog_record]` implements [`CatalogRecord`] and
//! emits the `inventory::submit!` for each record type.
//!
...
/// The hand-written half of a catalog record — everything `#[catalog_record]`
/// cannot generate.
...
/// the state change.
///
/// Generated by `#[catalog_record]`; write the [`RecordApply`] half by hand.
...
///
/// Emitted by `#[catalog_record]` and collected by `inventory`.
#[derive(Clone, Copy)]
