...
var (
	...
	integerBlocksMergeTimer        = metrics.MustRegisterTimer("integer_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	...
	unsignedBlocksMergeTimer       = metrics.MustRegisterTimer("unsigned_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	...
	stringBlocksMergeTimer         = metrics.MustRegisterTimer("string_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	...
	booleanBlocksMergeTimer        = metrics.MustRegisterTimer("boolean_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
