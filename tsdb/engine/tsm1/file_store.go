...
var (
	TsmGroupMergeTimeSuffix        = "merge_ns"
	...
	floatBlocksMergeTimeNS         = metrics.MustRegisterCounter("float_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	...
	integerBlocksMergeTimeNS       = metrics.MustRegisterCounter("integer_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	integerBlocksMergeCount        = metrics.MustRegisterCounter("integer_blocks_"+TsmGroupMergeCountSuffix, metrics.WithGroup(tsmGroup))
	integerBlocksMergeOver4Count   = metrics.MustRegisterCounter("integer_blocks_"+TsmGroupMergeOver4CountSuffix, metrics.WithGroup(tsmGroup))
	integerBlocksMergeValuesCount  = metrics.MustRegisterCounter("integer_blocks_"+TsmGroupMergeValuesCountSuffix, metrics.WithGroup(tsmGroup))
	...
	unsignedBlocksMergeTimeNS      = metrics.MustRegisterCounter("unsigned_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	unsignedBlocksMergeCount       = metrics.MustRegisterCounter("unsigned_blocks_"+TsmGroupMergeCountSuffix, metrics.WithGroup(tsmGroup))
	unsignedBlocksMergeOver4Count  = metrics.MustRegisterCounter("unsigned_blocks_"+TsmGroupMergeOver4CountSuffix, metrics.WithGroup(tsmGroup))
	unsignedBlocksMergeValuesCount = metrics.MustRegisterCounter("unsigned_blocks_"+TsmGroupMergeValuesCountSuffix, metrics.WithGroup(tsmGroup))
	...
	stringBlocksMergeTimeNS        = metrics.MustRegisterCounter("string_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	stringBlocksMergeCount         = metrics.MustRegisterCounter("string_blocks_"+TsmGroupMergeCountSuffix, metrics.WithGroup(tsmGroup))
	stringBlocksMergeOver4Count    = metrics.MustRegisterCounter("string_blocks_"+TsmGroupMergeOver4CountSuffix, metrics.WithGroup(tsmGroup))
	stringBlocksMergeValuesCount   = metrics.MustRegisterCounter("string_blocks_"+TsmGroupMergeValuesCountSuffix, metrics.WithGroup(tsmGroup))
	...
	booleanBlocksMergeTimeNS       = metrics.MustRegisterCounter("boolean_blocks_"+TsmGroupMergeTimeSuffix, metrics.WithGroup(tsmGroup))
	booleanBlocksMergeCount        = metrics.MustRegisterCounter("boolean_blocks_"+TsmGroupMergeCountSuffix, metrics.WithGroup(tsmGroup))
	booleanBlocksMergeOver4Count   = metrics.MustRegisterCounter("boolean_blocks_"+TsmGroupMergeOver4CountSuffix, metrics.WithGroup(tsmGroup))
	booleanBlocksMergeValuesCount  = metrics.MustRegisterCounter("boolean_blocks_"+TsmGroupMergeValuesCountSuffix, metrics.WithGroup(tsmGroup))
)
