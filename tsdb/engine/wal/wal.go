...
// Log represents an object that holds log information based in a partition
type Log struct {
	path string
...
// DiskSize returns the log's size
...
// WritePoints will persist series and fields and also write statistics about it
...
// Flush will force a flush on all partitions
