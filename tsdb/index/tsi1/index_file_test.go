...
func CreateIndexFile(sfile *tsi1.SeriesFile, series []Series) (*tsi1.IndexFile, error) {
...
func GenerateIndexFile(sfile *tsi1.SeriesFile, measurementN, tagN, valueN int) (*tsi1.IndexFile, error) {
...
func MustGenerateIndexFile(sfile *tsi1.SeriesFile, measurementN, tagN, valueN int) *tsi1.IndexFile {
...
func MustFindOrGenerateIndexFile(sfile *tsi1.SeriesFile, measurementN, tagN, valueN int) *tsi1.IndexFile {
