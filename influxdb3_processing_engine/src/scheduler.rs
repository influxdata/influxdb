...
pub(crate) const RUN_ASYNC_CONCURRENCY_LIMIT: usize = 8;
...
impl SchedulerConfig {
    pub(crate) fn new(queue_size: usize, run_async: bool) -> Self {
        Self {
            queue_size,
            max_concurrency: if run_async {
                RUN_ASYNC_CONCURRENCY_LIMIT
            } else {
                1
            },
