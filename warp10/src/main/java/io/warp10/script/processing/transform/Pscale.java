 ...
 */
public class Pscale extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public Pscale(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    List<Object> params = ProcessingUtil.parseParams(stack, 1, 2, 3);
