 ...
 */
public class PbezierVertex extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public PbezierVertex(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    List<Object> params = ProcessingUtil.parseParams(stack, 6, 9);
