 ...
 */
public class Ptriangle extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public Ptriangle(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    List<Object> params = ProcessingUtil.parseParams(stack, 6);
