 ...
 */
public class GeoSubtraction extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public GeoSubtraction(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(GeoXPLib.subtraction((GeoXPShape) b, (GeoXPShape) a));
