 ...
 */
public class SIGNUM extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public SIGNUM(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.signum(((Number) op0).doubleValue()));
