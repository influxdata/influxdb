 ...
 */
public class COPYSIGN extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public COPYSIGN(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.copySign(((Number) op1).doubleValue(), ((Number) op0).doubleValue()));
