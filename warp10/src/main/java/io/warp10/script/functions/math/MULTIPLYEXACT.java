 ...
 */
public class MULTIPLYEXACT extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public MULTIPLYEXACT(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if ((op1 instanceof Long || op1 instanceof Integer)
      ...
      try {
        stack.push(Math.multiplyExact(((Number) op1).longValue(), ((Number) op0).longValue()));
