 ...
 * 
 */
public class LASTBUCKET extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public LASTBUCKET(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (!(o instanceof GeoTimeSerie)) {
      ...
      if (!GTSHelper.isBucketized((GeoTimeSerie) o)) {
        ...
        stack.push(GTSHelper.getLastBucket((GeoTimeSerie) o));
      }
    }
    return stack;
  }
