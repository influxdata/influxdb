 ...
 */
public class COSH extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public COSH(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.cosh(((Number) op0).doubleValue()));
