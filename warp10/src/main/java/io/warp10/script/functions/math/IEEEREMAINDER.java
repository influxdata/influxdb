 ...
 */
public class IEEEREMAINDER extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public IEEEREMAINDER(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.IEEEremainder(((Number) op1).doubleValue(), ((Number) op0).doubleValue()));
