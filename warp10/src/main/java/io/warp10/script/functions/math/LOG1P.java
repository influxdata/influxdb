 ...
 */
public class LOG1P extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public LOG1P(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.log1p(((Number) op0).doubleValue()));
