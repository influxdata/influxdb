...
/**
 * Consumes the String on the stack or leave it there and stop the script
 * if the stack is currently in documentation mode
 */
public class DOC extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (!(top instanceof String)) {
      throw new WarpScriptException(getName() + " expects a documentation string on top of the stack.");
    }
