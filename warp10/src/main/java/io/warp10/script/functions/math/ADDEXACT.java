 ...
 */
public class ADDEXACT extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public ADDEXACT(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if ((op1 instanceof Long || op1 instanceof Integer)
      ...
      try {
        stack.push(Math.addExact(((Number) op1).longValue(), ((Number) op0).longValue()));
