 ...
 */
public class TODEGREES extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public TODEGREES(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.toDegrees(((Number) op0).doubleValue()));
