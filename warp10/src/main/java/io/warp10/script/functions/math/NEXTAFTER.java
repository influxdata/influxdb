 ...
 */
public class NEXTAFTER extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public NEXTAFTER(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.nextAfter(((Number) op1).doubleValue(), ((Number) op0).doubleValue()));
