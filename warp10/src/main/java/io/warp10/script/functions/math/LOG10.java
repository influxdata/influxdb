 ...
 */
public class LOG10 extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public LOG10(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.log10(((Number) op0).doubleValue()));
