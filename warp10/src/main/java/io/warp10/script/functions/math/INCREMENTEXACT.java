 ...
 */
public class INCREMENTEXACT extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public INCREMENTEXACT(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if ((op0 instanceof Long || op0 instanceof Integer)) {
      try {
        stack.push(Math.incrementExact(((Number) op0).longValue()));
