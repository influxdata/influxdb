 ...
 */
public class NEXTDOWN extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public NEXTDOWN(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.nextDown(((Number) op0).doubleValue()));
