 ...
 */
public class SINH extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public SINH(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.sinh(((Number) op0).doubleValue()));
