 ...
 */
public class NEXTUP extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public NEXTUP(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.nextUp(((Number) op0).doubleValue()));
