 ...
 */
public class TORADIANS extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public TORADIANS(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.toRadians(((Number) op0).doubleValue()));
