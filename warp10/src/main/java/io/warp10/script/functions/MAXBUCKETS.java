...
public class MAXBUCKETS extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (limit > (long) stack.getAttribute(WarpScriptStack.ATTRIBUTE_MAX_BUCKETS_HARD)) {
      throw new WarpScriptException(getName() + " cannot extend limit past " + stack.getAttribute(WarpScriptStack.ATTRIBUTE_MAX_BUCKETS_HARD));
    }
