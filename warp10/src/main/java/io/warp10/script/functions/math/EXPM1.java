 ...
 */
public class EXPM1 extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public EXPM1(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(Math.expm1(((Number) op0).doubleValue()));
