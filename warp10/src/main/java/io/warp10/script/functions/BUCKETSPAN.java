 ...
 * 
 */
public class BUCKETSPAN extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public BUCKETSPAN(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (!(o instanceof GeoTimeSerie)) {
      ...
      if (!GTSHelper.isBucketized((GeoTimeSerie) o)) {
        ...
        stack.push(GTSHelper.getBucketSpan((GeoTimeSerie) o));
      }
    }
    return stack;
  }
