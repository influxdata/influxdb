...
public class FilterLastGE extends NamedWarpScriptFunction implements WarpScriptFilterFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new FilterLastGE(getName(), threshold));
      return stack;
    }
  }
  
  public FilterLastGE(String name, Object threshold) throws WarpScriptException {
    super(name);
