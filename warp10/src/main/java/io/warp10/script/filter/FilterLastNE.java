...
public class FilterLastNE extends NamedWarpScriptFunction implements WarpScriptFilterFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new FilterLastNE(getName(), threshold));
      return stack;
    }
  }
  
  public FilterLastNE(String name, Object threshold) throws WarpScriptException {
    super(name);
      ...
      for (GeoTimeSerie serie: gtsinstances) {
        ...
        switch (type) {
          ...
          case STRING:
            ...
            break;
          case BOOLEAN:
            if (!((Boolean) threshold).equals(last)) {
              retained.add(serie);
            }
            break;
        }
