...
public class FilterLastLE extends NamedWarpScriptFunction implements WarpScriptFilterFunction {
  ...
  public FilterLastLE(String name, Object threshold) throws WarpScriptException {
    super(name);
