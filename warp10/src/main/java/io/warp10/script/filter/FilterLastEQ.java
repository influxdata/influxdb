...
public class FilterLastEQ extends NamedWarpScriptFunction implements WarpScriptFilterFunction {
  ...
  public FilterLastEQ(String name, Object threshold) throws WarpScriptException {
    super(name);
