 ...
 */
public class MapperGeoOutside extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new MapperGeoOutside(getName(), (GeoXPShape) shape));
      return stack;
    }
  }
   ...
   */
  public MapperGeoOutside(String name, GeoXPShape shape) {
    super(name);
    this.shape = shape;
  }
