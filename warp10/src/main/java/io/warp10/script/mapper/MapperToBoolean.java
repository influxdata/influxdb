 ...
 */
public class MapperToBoolean extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {

  public MapperToBoolean(String name) {
    super(name);
  }
  ...
  public Object apply(Object[] args) throws WarpScriptException {
    ...
    if (null != values[0]) {
      if (values[0] instanceof Long) {
        value = 0L != (long) values[0];
      } else if (values[0] instanceof Double) {
        value = 0.0D != (double) values[0];
