 ...
 */
public class MapperToString extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {

  public MapperToString(String name) {
    super(name);
  }
