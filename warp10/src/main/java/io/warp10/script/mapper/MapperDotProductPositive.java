 ...
 */
public class MapperDotProductPositive extends MapperDotProduct {
  ...
  public static class Builder extends MapperDotProduct.Builder {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new MapperDotProductPositive(getName(), mdp.getOmega()));
      return stack;
    }
  }
  ...
  public Object apply(Object[] args) throws WarpScriptException {
    ...
    if (null != result[3]) {
      result[3] = Math.max(0.0D, (double) result[3]);
    }
