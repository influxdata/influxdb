 ...
 */
public class MapperExp extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new MapperExp(getName(), value));
      return stack;
    }
  }
  ...
  public Object apply(Object[] args) throws WarpScriptException {
    ...
    if (values[0] instanceof Long) {
      value = Math.pow(dvalue, (long) values[0]);
    } else if (values[0] instanceof Double) {
      value = Math.pow(dvalue, (double) values[0]);
    } else {
