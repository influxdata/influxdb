 ...
 */
public class MapperMul extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new MapperMul(getName(), value));
      return stack;
    }
  }
  
  public MapperMul(String name, Object value) throws WarpScriptException {
    super(name);
