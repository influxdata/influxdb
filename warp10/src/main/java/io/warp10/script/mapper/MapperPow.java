 ...
 */
public class MapperPow extends NamedWarpScriptFunction implements WarpScriptMapperFunction, WarpScriptAggregatorFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new MapperPow(getName(), value));
      return stack;
    }
  }
  
  public MapperPow(String name, Object value) throws WarpScriptException {
    super(name);
    if (value instanceof Long) {
      this.dvalue = (long) value;
  ...
  public Object apply(Object[] args) throws WarpScriptException {
    ...
    if (values[0] instanceof Long) {
      value = Math.pow((long) values[0], dvalue);
    } else if (values[0] instanceof Double) {
      value = Math.pow((double) values[0], dvalue);
    } else {
