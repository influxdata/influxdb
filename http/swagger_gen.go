...
// Makefile (825B)
// README.md (2.468kB)
// cur_swagger.yml (182.937kB)
// swagger.yml (198.39kB)
...
var _makefile = []byte(`# List any generated files here
...
func makefile() (*asset, error) {
	...
	info := bindataFileInfo{name: "Makefile", size: 825, mode: os.FileMode(420), modTime: time.Unix(1548197448, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x6d, 0x6c, 0x3c, 0xcf, 0xdb, 0xa8, 0x37, 0xaa, 0xcd, 0x27, 0xbf, 0x87, 0xe4, 0xe, 0x2f, 0x7c, 0x3f, 0x69, 0x2f, 0xfa, 0xcd, 0x17, 0x56, 0x99, 0xc6, 0xe0, 0x2e, 0x2b, 0x41, 0x54, 0xd5, 0x39}}
	return a, nil
}

var _readmeMd = []byte((((((`# HTTP Handler Style Guide
...
func readmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "README.md", size: 2468, mode: os.FileMode(420), modTime: time.Unix(1547143950, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x3d, 0x37, 0x10, 0x14, 0x95, 0x67, 0x2b, 0xce, 0x85, 0xab, 0xcb, 0xbe, 0xcc, 0x61, 0x74, 0x4c, 0xc7, 0x75, 0x50, 0xa0, 0xde, 0xe0, 0x99, 0x7, 0xf5, 0xe4, 0x32, 0x7b, 0x1, 0xbc, 0xf, 0xcd}}
	return a, nil
}

var _cur_swaggerYml = []byte((((((`openapi: "3.0.0"
info:
...
paths:
  ...
  '/telegrafs/{telegrafID}/labels':
    ...
    post:
      ...
      responses:
        '200':
          description: a label for a telegraf config
          content:
            application/json:
              schema:
  ...
  '/dashboards/{dashboardID}/labels':
    ...
    post:
      ...
      responses:
        '200':
          description: a label for a dashboard
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/LabelResponse"
      ...
      parameters:
        ...
        - in: path
          ...
          schema:
            type: string
          required: true
          description: ID of the dashboard config
        - in: path
          name: labelID
          schema:
            type: string
  ...
  '/buckets/{bucketID}/labels':
    ...
    post:
      ...
      responses:
        '200':
          description: a label for a bucket
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/LabelResponse"
    ...
    delete:
      ...
      parameters:
        ...
        - in: path
          ...
          schema:
            type: string
          required: true
          description: ID of the bucket config
        - in: path
          name: labelID
          schema:
            type: string
      ...
      responses:
        '204':
          description: delete has been accepted
        '404':
          description: bucket config not found
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/Error"
    ...
    delete:
      ...
      parameters:
        ...
        - in: path
          ...
          schema:
            type: string
          required: true
          description: ID of the org config
        - in: path
          name: labelID
          schema:
            type: string
      ...
      responses:
        '204':
          description: delete has been accepted
        '404':
          description: org config not found
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/Error"
  ...
  '/tasks/{taskID}/labels':
    ...
    post:
      ...
      responses:
        '200':
          description: a label for a task
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/LabelResponse"
    ...
    delete:
      ...
      parameters:
        ...
        - in: path
          ...
          schema:
            type: string
          required: true
          description: ID of the task config
        - in: path
          name: labelID
          schema:
            type: string
      ...
      responses:
        '204':
          description: delete has been accepted
        '404':
          description: task config not found
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/Error"
  ...
  '/views/{viewID}/labels':
    ...
    post:
      ...
      responses:
        '200':
          description: a label for a view
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/LabelResponse"
    ...
    delete:
      ...
      parameters:
        ...
        - in: path
          ...
          schema:
            type: string
          required: true
          description: ID of the view config
        - in: path
          name: labelID
          schema:
            type: string
      ...
      responses:
        '204':
          description: delete has been accepted
        '404':
          description: view config not found
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/Error"
...
func cur_swaggerYmlBytes() ([]byte, error) {
	return _cur_swaggerYml, nil
}

func cur_swaggerYml() (*asset, error) {
	bytes, err := cur_swaggerYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "cur_swagger.yml", size: 182937, mode: os.FileMode(420), modTime: time.Unix(1548197448, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x5c, 0x2e, 0x0, 0x10, 0x8a, 0x28, 0x9b, 0xde, 0xfb, 0xac, 0x83, 0x2, 0x32, 0xcb, 0x18, 0xdc, 0x7d, 0x9f, 0x10, 0xb3, 0x87, 0x77, 0x6b, 0x6d, 0x67, 0x88, 0x8a, 0xd0, 0x8f, 0x56, 0x85, 0x23}}
	return a, nil
}

var _swaggerYml = []byte((((`openapi: "3.0.0"
info:
  title: Influx API Service
  version: 0.1.0
servers:
...
func swaggerYmlBytes() ([]byte, error) {
	return _swaggerYml, nil
}

func swaggerYml() (*asset, error) {
	bytes, err := swaggerYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "swagger.yml", size: 198390, mode: os.FileMode(420), modTime: time.Unix(1547854860, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x9b, 0x2c, 0x82, 0x79, 0xce, 0x2, 0x45, 0x50, 0x4e, 0xc1, 0x3f, 0x73, 0x30, 0x7d, 0x4a, 0xee, 0x6, 0xa8, 0x4e, 0x7e, 0x6, 0xf7, 0x11, 0xdb, 0xe3, 0x60, 0xb5, 0x44, 0xcb, 0x3d, 0x39, 0x56}}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"cur_swagger.yml": cur_swaggerYml,

	"swagger.yml": swaggerYml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"cur_swagger.yml": &bintree{cur_swaggerYml, map[string]*bintree{}},
	"swagger.yml":     &bintree{swaggerYml, map[string]*bintree{}},
}}
