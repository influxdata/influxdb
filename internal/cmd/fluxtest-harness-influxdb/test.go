...
func (t *testExecutor) Run(pkg *ast.Package, execute cmd.TestExecuteFunc) error {
	l := t.l.Launcher
	b := &influxdb.Bucket{
		OrgID: t.l.Org.ID,
	...
	err = t.executeWithOptions(bucketOpt, orgOpt, t.readOptAST, pkg, execute)
	if flags.wait {
...
func (t *testExecutor) executeWithOptions(bucketOpt, orgOpt *ast.OptionStatement, optionsAST *ast.File, pkg *ast.Package, execute cmd.TestExecuteFunc) error {
