...
curl -Ls https://github.com/influxdata/ui/releases/download/OSS-v2.0.9/sha256.txt --output sha256.txt

# Download the tar file containing the built UI assets.
curl -L https://github.com/influxdata/ui/releases/download/OSS-v2.0.9/build.tar.gz --output build.tar.gz
