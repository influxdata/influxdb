...
type Span struct {
	...
	Start        *timestamp.Timestamp `protobuf:"bytes,4,opt,name=Start,proto3" json:"Start,omitempty"` // [(gogoproto.customname) = "Start", (gogoproto.stdtime) = true, (gogoproto.nullable) = false];
...
func (x *Span) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
