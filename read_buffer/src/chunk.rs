...
mod test {
    ...
    fn add_remove_tables() {
        ...
        r#"read_buffer_column_bytes{db="mydb",encoding="BT_U32-FIXED",log_data_type="i64"} 192"#,
        r#"read_buffer_column_bytes{db="mydb",encoding="FBT_U8-FIXEDN",log_data_type="f64"} 906"#,
        r#"read_buffer_column_bytes{db="mydb",encoding="FIXED",log_data_type="f64"} 186"#,
        r#"read_buffer_column_bytes{db="mydb",encoding="FIXEDN",log_data_type="bool"} 672"#,
        r#"read_buffer_column_bytes{db="mydb",encoding="RLE",log_data_type="string"} 376"#,
