...
impl Partition {
    ...
    /// [`Catalog`](crate::catalog::Catalog) and not instantiated directly.
    pub(super) fn new(
        addr: PartitionAddr,
...
mod tests {
    use super::*;
    use crate::catalog::metrics::CatalogMetrics;
    use mutable_buffer::{test_helpers::write_lp_to_new_chunk, MBChunk};
