...
func TestLauncher_Write_Query_FieldKey(t *testing.T) {
	be := launcher.RunAndSetupNewLauncherOrFail(t, ctx)
...
func TestLauncher_QueryMemoryLimits(t *testing.T) {
	...
	for _, tc := range tcs {
		t.Run(tc.name, func(t *testing.T) {
			l := launcher.RunAndSetupNewLauncherOrFail(t, ctx, tc.setOpts)
...
func TestLauncher_QueryMemoryManager_ExceedMemory(t *testing.T) {
	...
	l := launcher.RunAndSetupNewLauncherOrFail(t, ctx, func(o *launcher.InfluxdOpts) {
