...
func TestRestoreCommand(t *testing.T) {
	...
	if index, err := s.WriteSeries("db", "default", []data.Point{data.NewPoint("cpu", nil, map[string]interface{}{"value": float64(100)}, now)}); err != nil {
	...
	if index, err := s.WriteSeries("newdb", "default", []data.Point{data.NewPoint("mem", nil, map[string]interface{}{"value": float64(1000)}, now)}); err != nil {
