...
func TestRestoreCommand(t *testing.T) {
	...
	if index, err := s.WriteSeries("db", "default", []influxdb.Point{{Measurement: "cpu", Time: now, Fields: map[string]interface{}{"value": float64(100)}}}); err != nil {
	...
	if index, err := s.WriteSeries("newdb", "default", []influxdb.Point{{Measurement: "mem", Time: now, Fields: map[string]interface{}{"value": float64(1000)}}}); err != nil {
