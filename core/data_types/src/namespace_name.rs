...
mod tests {
    ...
    fn test_bad_chars_null() {
        ...
        assert_eq!(
            got.to_string(),
            "namespace name 'example\x00' contains invalid character, character number 7 is not allowed"
        );
    }
    ...
    fn test_bad_chars_high_control() {
        ...
        assert_eq!(
            got.to_string(),
            "namespace name '\u{007f}example' contains invalid character, character number 0 is not allowed"
        );
    }
    ...
    fn test_bad_chars_tab() {
        ...
        assert_eq!(
            got.to_string(),
            "namespace name 'example\tdb' contains invalid character, character number 7 is not allowed"
        );
    }
    ...
    fn test_bad_chars_whitespace() {
        ...
        assert_eq!(
            got.to_string(),
            "namespace name 'my_example db' contains invalid character, character number 10 is not allowed"
        );
    }
