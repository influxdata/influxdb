...
async fn target_too_large_2() {
    ...
    - "**** 2 Output Files (parquet_file_id not yet assigned), 50mb total:"
    - "L1                                                                                                                 "
    - "L1.?[1001,1001] 11ns 0b  |L1.?|                                                                                    "
    - "L1.?[1002,2000] 11ns 50mb|-----------------------------------------L1.?------------------------------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L1.3"
    - "  Creating 2 files"
    - "**** Simulation run 2, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[685]). 3 Input Files, 146mb total:"
    - "L1                                                                                                                 "
    - "L1.2[1,1000] 10ns 69mb   |-----------------------------------------L1.2------------------------------------------| "
    - "L1.6[1001,1001] 11ns 0b                                                                                            |L1.6|"
    - "L2                                                                                                                 "
    - "L2.4[1,1001] 5ns 77mb    |------------------------------------------L2.4------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 146mb total:"
    - "L2                                                                                                                 "
    - "L2.?[1,685] 11ns 100mb   |---------------------------L2.?----------------------------|                             "
    - "L2.?[686,1001] 11ns 46mb                                                              |-----------L2.?-----------| "
    - "Committing partition 1:"
    ...
    - "L2.8[1,685] 11ns 100mb   |-------L2.8-------|                                                                      "
    - "L2.9[686,1001] 11ns 46mb                     |-L2.9--|                                                             "
...
async fn start_too_large_similar_time_range() {
    ...
    - "L1                                                                                                                 "
    - "L1.?[402,402] 9ns 0b     |L1.?|                                                                                    "
    - "L1.?[403,801] 9ns 100mb  |-----------------------------------------L1.?------------------------------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L1.4, L1.5"
    - "  Creating 4 files"
    - "**** Simulation run 4, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[333, 665]). 6 Input Files, 242mb total:"
    - "L1                                                                                                                 "
    - "L1.3[1,401] 9ns 100mb    |-------------------L1.3-------------------|                                              "
    - "L1.11[402,402] 9ns 0b                                                 |L1.11|                                      "
    - "L1.12[403,801] 9ns 100mb                                              |------------------L1.12-------------------| "
    - "L1.9[802,802] 9ns 0b                                                                                               |L1.9|"
    - "L2                                                                                                                 "
    - "L2.6[2,402] 8ns 21mb     |-------------------L2.6-------------------|                                              "
    - "L2.7[403,802] 8ns 21mb                                                |-------------------L2.7-------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 242mb total:"
    - "L2                                                                                                                 "
    - "L2.?[1,333] 9ns 100mb    |---------------L2.?----------------|                                                     "
    - "L2.?[334,665] 9ns 100mb                                       |---------------L2.?----------------|                "
    - "L2.?[666,802] 9ns 42mb                                                                             |----L2.?-----| "
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L1.3, L2.6, L2.7, L1.9, L1.11, L1.12"
    - "  Creating 3 files"
    - "**** Final Output Files (693mb written)"
    - "L1                                                                                                                 "
    - "L1.10[803,1000] 9ns 50mb                                                                         |-----L1.10-----| "
    - "L2                                                                                                                 "
    - "L2.8[803,1000] 8ns 10mb                                                                          |-----L2.8------| "
    - "L2.13[1,333] 9ns 100mb   |-----------L2.13-----------|                                                             "
    - "L2.14[334,665] 9ns 100mb                               |-----------L2.14-----------|                               "
    - "L2.15[666,802] 9ns 42mb                                                             |--L2.15---|                   "
    "###
    );
}
