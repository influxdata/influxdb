...
async fn many_l0_files_different_created_order_non_overlap() {
    ...
    - "  Creating 1 files"
    - "**** Simulation run 2, type=compact(FoundSubsetLessThanMaxCompactSize). 2 Input Files, 8kb total:"
    - "L0                                                                                                                 "
    - "L0.6[21,40] 3ns 5kb      |--------------------------L0.6--------------------------|                                "
    - "L0.4[41,50] 4ns 3kb                                                                    |----------L0.4-----------| "
    - "**** 1 Output Files (parquet_file_id not yet assigned), 8kb total:"
    - "L1, all files 8kb                                                                                                  "
    - "L1.?[21,50] 4ns          |------------------------------------------L1.?------------------------------------------|"
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.4, L0.6"
    - "  Creating 1 files"
    - "**** Simulation run 3, type=compact(FoundSubsetLessThanMaxCompactSize). 2 Input Files, 10kb total:"
    - "L1                                                                                                                 "
    - "L1.5[11,20] 1ns 3kb      |-------L1.5-------|                                                                      "
    - "L1.7[21,50] 4ns 8kb                             |------------------------------L1.7------------------------------| "
    - "**** 1 Output Files (parquet_file_id not yet assigned), 10kb total:"
    - "L2, all files 10kb                                                                                                 "
    - "L2.?[11,50] 4ns          |------------------------------------------L2.?------------------------------------------|"
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L1.5, L1.7"
    - "  Creating 1 files"
