...
async fn many_l0_files_different_created_order_non_overlap() {
    ...
    - "L0.3[21,30] 3ns                                 |-------L0.3-------|                                               "
    - "L0.4[41,50] 4ns                                                                               |-------L0.4-------| "
    - "**** Simulation run 0, type=compact(TotalSizeLessThanMaxCompactSize). 1 Input Files, 3kb total:"
    - "L0, all files 3kb                                                                                                  "
    - "L0.1[11,20] 1ns          |------------------------------------------L0.1------------------------------------------|"
    - "**** 1 Output Files (parquet_file_id not yet assigned), 3kb total:"
    - "L1, all files 3kb                                                                                                  "
    - "L1.?[11,20] 1ns          |------------------------------------------L1.?------------------------------------------|"
    - "Committing partition 1:"
    ...
    - "L1.?[21,40] 3ns          |------------------------------------------L1.?------------------------------------------|"
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.2, L0.3"
    - "  Creating 1 files"
    - "**** Simulation run 2, type=compact(TotalSizeLessThanMaxCompactSize). 3 Input Files, 10kb total:"
    - "L0                                                                                                                 "
    - "L0.4[41,50] 4ns 3kb                                                                           |-------L0.4-------| "
    - "L1                                                                                                                 "
    - "L1.6[21,40] 3ns 5kb                             |------------------L1.6-------------------|                        "
    - "L1.5[11,20] 1ns 3kb      |-------L1.5-------|                                                                      "
    - "**** 1 Output Files (parquet_file_id not yet assigned), 10kb total:"
    - "L1, all files 10kb                                                                                                 "
    - "L1.?[11,50] 4ns          |------------------------------------------L1.?------------------------------------------|"
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L0.4, L1.5, L1.6"
    - "  Creating 1 files"
    - "**** Final Output Files (18kb written)"
    - "L1, all files 10kb                                                                                                 "
    - "L1.7[11,50] 4ns          |------------------------------------------L1.7------------------------------------------|"
    "###
    );
...
async fn l0s_almost_needing_vertical_split() {
    ...
    let actual_file_size = max_compact_size / (max_files_per_plan * 2) / 3;
    ...
    - "**** Final Output Files (545mb written)"
    - "L2                                                                                                                 "
    - "L2.1006[24,55] 1.02us 104mb|-------------L2.1006--------------|                                                      "
    - "L2.1007[56,86] 1.02us 101mb                                     |-------------L2.1007-------------|                  "
    - "L2.1009[87,97] 1.02us 36mb                                                                          |-L2.1009-|     "
    - "L2.1010[98,100] 1.02us 10mb                                                                                       |L2.1010|"
    - "**** Breakdown of where bytes were written"
    - 250mb written by compact(ManySmallFiles)
    - 295mb written by split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))
    "###
    );
}

// Same as the above case, but larger files needing a vertical split.
#[tokio::test]
async fn l0s_needing_vertical_split() {
    test_helpers::maybe_start_logging();
    ...
    - "L2                                                                                                                 "
    - "L2.1031[24,34] 1.02us 107mb|-L2.1031-|                                                                               "
    - "L2.1039[81,91] 1.02us 107mb                                                                   |-L2.1039-|            "
    - "L2.1040[92,100] 1.02us 88mb                                                                                |L2.1040| "
    - "L2.1041[35,45] 1.02us 107mb             |-L2.1041-|                                                                  "
    - "L2.1042[46,55] 1.02us 97mb                          |L2.1042-|                                                      "
    - "L2.1043[56,63] 1.02us 78mb                                     |L2.1043|                                            "
    - "L2.1044[64,74] 1.02us 107mb                                               |-L2.1044-|                                "
    - "L2.1045[75,80] 1.02us 58mb                                                            |L2.1045|                     "
    - "**** Breakdown of where bytes were written"
