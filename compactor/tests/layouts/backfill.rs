...
async fn random_backfill_empty_partition() {
    ...
    - "**** Simulation run 0, type=compact(ManySmallFiles). 20 Input Files, 200mb total:"
    - "L0, all files 10mb                                                                                                 "
    - "L0.1[76,932] 1us            |-------------------------------------L0.1--------------------------------------|      "
    - "L0.2[42,986] 1us         |------------------------------------------L0.2------------------------------------------|"
    - "L0.3[173,950] 1us                    |----------------------------------L0.3----------------------------------|    "
    ...
    - "  Creating 1 files"
    - "**** Simulation run 3, type=split(HighL0OverlapSingleFile)(split_times=[356, 670]). 1 Input Files, 200mb total:"
    - "L0, all files 200mb                                                                                                "
    - "L0.52[42,986] 1.02us     |-----------------------------------------L0.52------------------------------------------|"
    ...
    - "L0, all files 100mb                                                                                                "
    - "L0.54[42,986] 1.05us     |-----------------------------------------L0.54------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L0                                                                                                                 "
    - "L0.?[42,356] 1.05us 33mb |-----------L0.?------------|                                                             "
    - "L0.?[357,670] 1.05us 33mb                              |-----------L0.?------------|                               "
    - "L0.?[671,986] 1.05us 33mb                                                           |------------L0.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L0.52, L0.53, L0.54"
    - "  Creating 9 files"
    - "**** Simulation run 6, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[357, 714]). 5 Input Files, 277mb total:"
    - "L0                                                                                                                 "
    - "L0.51[0,1] 999ns 10mb    |L0.51|                                                                                   "
    - "L0.55[42,356] 1.02us 67mb   |----------L0.55-----------|                                                           "
    - "L0.56[357,670] 1.02us 66mb                                |----------L0.56-----------|                              "
    - "L0.57[671,986] 1.02us 67mb                                                             |----------L0.57-----------| "
    - "L0.58[42,356] 1.04us 67mb   |----------L0.58-----------|                                                           "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 277mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,357] 1.04us 100mb |-------------L1.?-------------|                                                          "
    - "L1.?[358,714] 1.04us 100mb                                |-------------L1.?-------------|                          "
    - "L1.?[715,986] 1.04us 76mb                                                                 |---------L1.?---------| "
    - "Committing partition 1:"
    - "  Soft Deleting 5 files: L0.51, L0.55, L0.56, L0.57, L0.58"
    - "  Creating 3 files"
    - "**** Simulation run 7, type=split(HighL0OverlapSingleFile)(split_times=[476]). 1 Input Files, 66mb total:"
    - "L0, all files 66mb                                                                                                 "
    - "L0.59[357,670] 1.04us    |-----------------------------------------L0.59------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 66mb total:"
    - "L0                                                                                                                 "
    - "L0.?[357,476] 1.04us 25mb|--------------L0.?--------------|                                                        "
    - "L0.?[477,670] 1.04us 41mb                                  |------------------------L0.?-------------------------| "
    - "**** Simulation run 8, type=split(HighL0OverlapSingleFile)(split_times=[476]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.65[358,714] 1.04us    |-----------------------------------------L1.65------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[358,476] 1.04us 33mb|-----------L1.?------------|                                                             "
    - "L1.?[477,714] 1.04us 67mb                              |--------------------------L1.?---------------------------| "
    - "**** Simulation run 9, type=split(HighL0OverlapSingleFile)(split_times=[238]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.64[0,357] 1.04us      |-----------------------------------------L1.64------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,238] 1.04us 67mb  |---------------------------L1.?---------------------------|                              "
    - "L1.?[239,357] 1.04us 33mb                                                            |-----------L1.?------------| "
    - "**** Simulation run 10, type=split(HighL0OverlapSingleFile)(split_times=[476]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.62[357,670] 1.05us    |-----------------------------------------L0.62------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[357,476] 1.05us 13mb|--------------L0.?--------------|                                                        "
    - "L0.?[477,670] 1.05us 21mb                                  |------------------------L0.?-------------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L0.59, L0.62, L1.64, L1.65"
    - "  Creating 8 files"
    - "**** Simulation run 11, type=split(ReduceOverlap)(split_times=[714]). 1 Input Files, 67mb total:"
    - "L0, all files 67mb                                                                                                 "
    - "L0.60[671,986] 1.04us    |-----------------------------------------L0.60------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 67mb total:"
    - "L0                                                                                                                 "
    - "L0.?[671,714] 1.04us 9mb |---L0.?---|                                                                              "
    - "L0.?[715,986] 1.04us 58mb            |-----------------------------------L0.?------------------------------------| "
    - "**** Simulation run 12, type=split(ReduceOverlap)(split_times=[357]). 1 Input Files, 25mb total:"
    - "L0, all files 25mb                                                                                                 "
    - "L0.67[357,476] 1.04us    |-----------------------------------------L0.67------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 25mb total:"
    - "L0                                                                                                                 "
    - "L0.?[357,357] 1.04us 217kb|L0.?|                                                                                    "
    - "L0.?[358,476] 1.04us 25mb|-----------------------------------------L0.?------------------------------------------| "
    - "**** Simulation run 13, type=split(ReduceOverlap)(split_times=[238]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.61[42,356] 1.05us     |-----------------------------------------L0.61------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[42,238] 1.05us 21mb |-------------------------L0.?-------------------------|                                  "
    - "L0.?[239,356] 1.05us 12mb                                                        |-------------L0.?--------------| "
    - "**** Simulation run 14, type=split(ReduceOverlap)(split_times=[714]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    ...
    - "**** Simulation run 15, type=split(ReduceOverlap)(split_times=[357]). 1 Input Files, 13mb total:"
    - "L0, all files 13mb                                                                                                 "
    - "L0.73[357,476] 1.05us    |-----------------------------------------L0.73------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 13mb total:"
    - "L0                                                                                                                 "
    - "L0.?[357,357] 1.05us 108kb|L0.?|                                                                                    "
    - "L0.?[358,476] 1.05us 13mb|-----------------------------------------L0.?------------------------------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 5 files: L0.60, L0.61, L0.63, L0.67, L0.73"
    - "  Creating 10 files"
    - "**** Simulation run 16, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[467, 695]). 7 Input Files, 209mb total:"
    - "L0                                                                                                                 "
    - "L0.77[357,357] 1.04us 217kb                      |L0.77|                                                             "
    - "L0.78[358,476] 1.04us 25mb                      |-------L0.78--------|                                              "
    - "L0.68[477,670] 1.04us 41mb                                             |--------------L0.68---------------|         "
    - "L0.75[671,714] 1.04us 9mb                                                                                 |L0.75-| "
    - "L1                                                                                                                 "
    - "L1.72[239,357] 1.04us 33mb|-------L1.72--------|                                                                    "
    - "L1.69[358,476] 1.04us 33mb                      |-------L1.69--------|                                              "
    - "L1.70[477,714] 1.04us 67mb                                             |------------------L1.70-------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 209mb total:"
    - "L1                                                                                                                 "
    - "L1.?[239,467] 1.04us 101mb|------------------L1.?-------------------|                                               "
    - "L1.?[468,695] 1.04us 100mb                                           |------------------L1.?-------------------|    "
    - "L1.?[696,714] 1.04us 8mb                                                                                       |L1.?|"
    - "Committing partition 1:"
    - "  Soft Deleting 7 files: L0.68, L1.69, L1.70, L1.72, L0.75, L0.77, L0.78"
    - "  Creating 3 files"
    - "**** Simulation run 17, type=split(ReduceOverlap)(split_times=[695]). 1 Input Files, 5mb total:"
    - "L0, all files 5mb                                                                                                  "
    - "L0.81[671,714] 1.05us    |-----------------------------------------L0.81------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 5mb total:"
    - "L0                                                                                                                 "
    - "L0.?[671,695] 1.05us 3mb |----------------------L0.?----------------------|                                        "
    - "L0.?[696,714] 1.05us 2mb                                                     |---------------L0.?----------------| "
    - "**** Simulation run 18, type=split(ReduceOverlap)(split_times=[467]). 1 Input Files, 13mb total:"
    - "L0, all files 13mb                                                                                                 "
    - "L0.84[358,476] 1.05us    |-----------------------------------------L0.84------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 13mb total:"
    - "L0                                                                                                                 "
    - "L0.?[358,467] 1.05us 12mb|--------------------------------------L0.?---------------------------------------|       "
    - "L0.?[468,476] 1.05us 975kb                                                                                   |L0.?| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.81, L0.84"
    - "  Creating 4 files"
    - "**** Simulation run 19, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[918]). 2 Input Files, 134mb total:"
    - "L0                                                                                                                 "
    - "L0.76[715,986] 1.04us 58mb|-----------------------------------------L0.76------------------------------------------|"
    - "L1                                                                                                                 "
    - "L1.66[715,986] 1.04us 76mb|-----------------------------------------L1.66------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 134mb total:"
    - "L1                                                                                                                 "
    - "L1.?[715,918] 1.04us 100mb|------------------------------L1.?-------------------------------|                       "
    - "L1.?[919,986] 1.04us 33mb                                                                   |--------L1.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L1.66, L0.76"
    - "  Creating 2 files"
    - "**** Simulation run 20, type=split(ReduceOverlap)(split_times=[918]). 1 Input Files, 29mb total:"
    - "L0, all files 29mb                                                                                                 "
    - "L0.82[715,986] 1.05us    |-----------------------------------------L0.82------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 29mb total:"
    - "L0                                                                                                                 "
    - "L0.?[715,918] 1.05us 22mb|------------------------------L0.?-------------------------------|                       "
    - "L0.?[919,986] 1.05us 7mb                                                                    |--------L0.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L0.82"
    - "  Creating 2 files"
    - "**** Simulation run 21, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[220, 440]). 6 Input Files, 213mb total:"
    - "L0                                                                                                                 "
    - "L0.79[42,238] 1.05us 21mb        |---------------L0.79---------------|                                             "
    - "L0.80[239,356] 1.05us 12mb                                              |-------L0.80--------|                      "
    - "L0.83[357,357] 1.05us 108kb                                                                    |L0.83|               "
    - "L0.90[358,467] 1.05us 12mb                                                                    |-------L0.90-------| "
    - "L1                                                                                                                 "
    - "L1.71[0,238] 1.04us 67mb |-------------------L1.71-------------------|                                             "
    - "L1.85[239,467] 1.04us 101mb                                              |------------------L1.85------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 213mb total:"
    - "L1                                                                                                                 "
    - "L1.?[0,220] 1.05us 100mb |------------------L1.?------------------|                                                "
    - "L1.?[221,440] 1.05us 100mb                                          |------------------L1.?------------------|      "
    - "L1.?[441,467] 1.05us 12mb                                                                                    |L1.?|"
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L1.71, L0.79, L0.80, L0.83, L1.85, L0.90"
    - "  Creating 3 files"
    - "**** Simulation run 22, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[643, 818]). 10 Input Files, 297mb total:"
    - "L0                                                                                                                 "
    - "L0.95[919,986] 1.05us 7mb                                                                              |--L0.95--| "
    - "L0.94[715,918] 1.05us 22mb                                          |--------------L0.94--------------|             "
    - "L0.89[696,714] 1.05us 2mb                                       |L0.89|                                            "
    - "L0.88[671,695] 1.05us 3mb                                   |L0.88|                                                "
    - "L0.74[477,670] 1.05us 21mb |-------------L0.74-------------|                                                        "
    - "L0.91[468,476] 1.05us 975kb|L0.91|                                                                                   "
    - "L1                                                                                                                 "
    - "L1.93[919,986] 1.04us 33mb                                                                              |--L1.93--| "
    - "L1.92[715,918] 1.04us 100mb                                          |--------------L1.92--------------|             "
    - "L1.87[696,714] 1.04us 8mb                                       |L1.87|                                            "
    - "L1.86[468,695] 1.04us 100mb|----------------L1.86----------------|                                                   "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 297mb total:"
    - "L1                                                                                                                 "
    - "L1.?[468,643] 1.05us 101mb|------------L1.?------------|                                                            "
    - "L1.?[644,818] 1.05us 100mb                              |------------L1.?------------|                              "
    - "L1.?[819,986] 1.05us 96mb                                                            |-----------L1.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 10 files: L0.74, L1.86, L1.87, L0.88, L0.89, L0.91, L1.92, L1.93, L0.94, L0.95"
    - "  Creating 3 files"
    - "**** Simulation run 23, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[420, 619]). 3 Input Files, 213mb total:"
    - "L1                                                                                                                 "
    - "L1.97[221,440] 1.05us 100mb|-------------------L1.97--------------------|                                            "
    - "L1.98[441,467] 1.05us 12mb                                              |L1.98|                                     "
    - "L1.99[468,643] 1.05us 101mb                                                    |---------------L1.99---------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 213mb total:"
    - "L2                                                                                                                 "
    - "L2.?[221,420] 1.05us 101mb|------------------L2.?------------------|                                                "
    - "L2.?[421,619] 1.05us 100mb                                          |------------------L2.?------------------|      "
    - "L2.?[620,643] 1.05us 12mb                                                                                     |L2.?|"
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L1.97, L1.98, L1.99"
    - "  Upgrading 1 files level to CompactionLevel::L2: L1.96"
    - "  Creating 3 files"
    - "**** Simulation run 24, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[952]). 1 Input Files, 96mb total:"
    - "L1, all files 96mb                                                                                                 "
    - "L1.101[819,986] 1.05us   |-----------------------------------------L1.101-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 96mb total:"
    - "L2                                                                                                                 "
    - "L2.?[819,952] 1.05us 77mb|--------------------------------L2.?---------------------------------|                   "
    - "L2.?[953,986] 1.05us 19mb                                                                        |-----L2.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L1.101"
    - "  Upgrading 1 files level to CompactionLevel::L2: L1.100"
    - "  Creating 2 files"
    - "**** Final Output Files (2.89gb written)"
    - "L2                                                                                                                 "
    - "L2.96[0,220] 1.05us 100mb|------L2.96-------|                                                                      "
    - "L2.100[644,818] 1.05us 100mb                                                          |---L2.100----|                 "
    - "L2.102[221,420] 1.05us 101mb                    |-----L2.102-----|                                                    "
    - "L2.103[421,619] 1.05us 100mb                                      |-----L2.103-----|                                  "
    - "L2.104[620,643] 1.05us 12mb                                                        |L2.104|                          "
    - "L2.105[819,952] 1.05us 77mb                                                                          |--L2.105--|    "
    - "L2.106[953,986] 1.05us 19mb                                                                                      |L2.106|"
    "###
    );
}
...
async fn random_backfill_over_l2s() {
    ...
    - "  Creating 3 files"
    - "**** Simulation run 11, type=split(ReduceOverlap)(split_times=[672]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.77[671,986] 1.04us    |-----------------------------------------L0.77------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[671,672] 1.04us 217kb|L0.?|                                                                                    "
    ...
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[357,357] 1.04us 108kb|L0.?|                                                                                    "
    - "L0.?[358,670] 1.04us 33mb|-----------------------------------------L0.?------------------------------------------| "
    - "**** Simulation run 13, type=split(ReduceOverlap)(split_times=[672]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.80[671,986] 1.05us    |-----------------------------------------L0.80------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[671,672] 1.05us 217kb|L0.?|                                                                                    "
    ...
    - "  Creating 8 files"
    - "**** Simulation run 15, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[260, 478, 696, 914]). 10 Input Files, 433mb total:"
    - "L0                                                                                                                 "
    - "L0.75[42,356] 1.04us 33mb|-----------L0.75-----------|                                                             "
    - "L0.86[357,357] 1.04us 108kb                              |L0.86|                                                     "
    - "L0.87[358,670] 1.04us 33mb                              |-----------L0.87-----------|                               "
    - "L0.84[671,672] 1.04us 217kb                                                           |L0.84|                        "
    - "L0.85[673,986] 1.04us 33mb                                                            |-----------L0.85-----------| "
    - "L0.78[42,356] 1.05us 33mb|-----------L0.78-----------|                                                             "
    - "L0.90[357,357] 1.05us 108kb                              |L0.90|                                                     "
    - "L1                                                                                                                 "
    - "L1.81[42,357] 1.03us 100mb|-----------L1.81------------|                                                            "
    - "L1.82[358,672] 1.03us 100mb                              |-----------L1.82-----------|                               "
    - "L1.83[673,986] 1.03us 100mb                                                            |-----------L1.83-----------| "
    - "**** 5 Output Files (parquet_file_id not yet assigned), 433mb total:"
    - "L1                                                                                                                 "
    - "L1.?[42,260] 1.05us 100mb|-------L1.?-------|                                                                      "
    - "L1.?[261,478] 1.05us 100mb                    |-------L1.?-------|                                                  "
    - "L1.?[479,696] 1.05us 100mb                                         |-------L1.?-------|                             "
    - "L1.?[697,914] 1.05us 100mb                                                              |-------L1.?-------|        "
    - "L1.?[915,986] 1.05us 33mb                                                                                   |L1.?| "
    - "Committing partition 1:"
    - "  Soft Deleting 10 files: L0.75, L0.78, L1.81, L1.82, L1.83, L0.84, L0.85, L0.86, L0.87, L0.90"
    - "  Creating 5 files"
    - "**** Simulation run 16, type=split(ReduceOverlap)(split_times=[696, 914]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.89[673,986] 1.05us    |-----------------------------------------L0.89------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[673,696] 1.05us 3mb |L0.?|                                                                                    "
    - "L0.?[697,914] 1.05us 23mb      |----------------------------L0.?----------------------------|                      "
    - "L0.?[915,986] 1.05us 8mb                                                                      |-------L0.?-------| "
    - "**** Simulation run 17, type=split(ReduceOverlap)(split_times=[478]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.91[358,670] 1.05us    |-----------------------------------------L0.91------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[358,478] 1.05us 13mb|--------------L0.?--------------|                                                        "
    - "L0.?[479,670] 1.05us 20mb                                  |------------------------L0.?-------------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.89, L0.91"
    - "  Creating 5 files"
    - "**** Simulation run 18, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[446, 631]). 6 Input Files, 236mb total:"
    - "L0                                                                                                                 "
    - "L0.100[358,478] 1.05us 13mb                    |--------L0.100--------|                                              "
    - "L0.101[479,670] 1.05us 20mb                                             |---------------L0.101----------------|      "
    - "L0.88[671,672] 1.05us 217kb                                                                                    |L0.88|"
    - "L0.97[673,696] 1.05us 3mb                                                                                     |L0.97|"
    - "L1                                                                                                                 "
    - "L1.93[261,478] 1.05us 100mb|------------------L1.93-------------------|                                              "
    - "L1.94[479,696] 1.05us 100mb                                             |------------------L1.94-------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 236mb total:"
    - "L1                                                                                                                 "
    - "L1.?[261,446] 1.05us 101mb|----------------L1.?----------------|                                                    "
    - "L1.?[447,631] 1.05us 100mb                                      |----------------L1.?----------------|              "
    - "L1.?[632,696] 1.05us 35mb                                                                            |---L1.?----| "
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L0.88, L1.93, L1.94, L0.97, L0.100, L0.101"
    - "  Creating 3 files"
    - "**** Simulation run 19, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[874]). 4 Input Files, 164mb total:"
    - "L0                                                                                                                 "
    - "L0.99[915,986] 1.05us 8mb                                                                   |-------L0.99--------| "
    - "L0.98[697,914] 1.05us 23mb|------------------------------L0.98------------------------------|                       "
    - "L1                                                                                                                 "
    - "L1.96[915,986] 1.05us 33mb                                                                   |-------L1.96--------| "
    - "L1.95[697,914] 1.05us 100mb|------------------------------L1.95------------------------------|                       "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 164mb total:"
    - "L1                                                                                                                 "
    - "L1.?[697,874] 1.05us 100mb|------------------------L1.?-------------------------|                                   "
    - "L1.?[875,986] 1.05us 63mb                                                       |--------------L1.?--------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L1.95, L1.96, L0.98, L0.99"
    - "  Creating 2 files"
    - "**** Simulation run 20, type=split(ReduceOverlap)(split_times=[499, 599]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.103[447,631] 1.05us   |-----------------------------------------L1.103-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[447,499] 1.05us 29mb|---------L1.?----------|                                                                 "
    - "L1.?[500,599] 1.05us 54mb                         |---------------------L1.?---------------------|                 "
    - "L1.?[600,631] 1.05us 17mb                                                                          |----L1.?-----| "
    - "**** Simulation run 21, type=split(ReduceOverlap)(split_times=[299, 399]). 1 Input Files, 101mb total:"
    - "L1, all files 101mb                                                                                                "
    - "L1.102[261,446] 1.05us   |-----------------------------------------L1.102-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 101mb total:"
    - "L1                                                                                                                 "
    - "L1.?[261,299] 1.05us 21mb|------L1.?------|                                                                        "
    - "L1.?[300,399] 1.05us 54mb                  |---------------------L1.?---------------------|                        "
    - "L1.?[400,446] 1.05us 25mb                                                                   |--------L1.?--------| "
    - "**** Simulation run 22, type=split(ReduceOverlap)(split_times=[99, 199]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.92[42,260] 1.05us     |-----------------------------------------L1.92------------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[42,99] 1.05us 27mb  |--------L1.?---------|                                                                   "
    - "L1.?[100,199] 1.05us 46mb                       |-----------------L1.?-----------------|                           "
    - "L1.?[200,260] 1.05us 28mb                                                                 |---------L1.?---------| "
    - "**** Simulation run 23, type=split(ReduceOverlap)(split_times=[899]). 1 Input Files, 63mb total:"
    - "L1, all files 63mb                                                                                                 "
    - "L1.106[875,986] 1.05us   |-----------------------------------------L1.106-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 63mb total:"
    - "L1                                                                                                                 "
    - "L1.?[875,899] 1.05us 14mb|------L1.?-------|                                                                       "
    - "L1.?[900,986] 1.05us 49mb                    |-------------------------------L1.?--------------------------------| "
    - "**** Simulation run 24, type=split(ReduceOverlap)(split_times=[699, 799]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.105[697,874] 1.05us   |-----------------------------------------L1.105-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[697,699] 1.05us 2mb |L1.?|                                                                                    "
    - "L1.?[700,799] 1.05us 56mb |----------------------L1.?----------------------|                                       "
    - "L1.?[800,874] 1.05us 42mb                                                    |---------------L1.?----------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 5 files: L1.92, L1.102, L1.103, L1.105, L1.106"
    - "  Creating 14 files"
    - "**** Simulation run 25, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[74, 148]). 4 Input Files, 272mb total:"
    - "L1                                                                                                                 "
    - "L1.113[42,99] 1.05us 27mb                  |--------L1.113---------|                                               "
    - "L1.114[100,199] 1.05us 46mb                                             |------------------L1.114------------------| "
    - "L2                                                                                                                 "
    - "L2.1[0,99] 99ns 100mb    |-------------------L2.1-------------------|                                              "
    - "L2.2[100,199] 199ns 100mb                                             |-------------------L2.2-------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 272mb total:"
    - "L2                                                                                                                 "
    - "L2.?[0,74] 1.05us 102mb  |-------------L2.?--------------|                                                         "
    - "L2.?[75,148] 1.05us 101mb                                 |-------------L2.?--------------|                        "
    - "L2.?[149,199] 1.05us 69mb                                                                   |--------L2.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L2.1, L2.2, L1.113, L1.114"
    - "  Creating 3 files"
    - "**** Simulation run 26, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[267]). 3 Input Files, 149mb total:"
    - "L1                                                                                                                 "
    - "L1.115[200,260] 1.05us 28mb|-----------------------L1.115-----------------------|                                    "
    - "L1.110[261,299] 1.05us 21mb                                                       |-------------L1.110-------------| "
    - "L2                                                                                                                 "
    - "L2.3[200,299] 299ns 100mb|-----------------------------------------L2.3------------------------------------------| "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.3, L1.110, L1.115"
    - "  Creating 2 files"
    - "**** Simulation run 27, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[365]). 2 Input Files, 154mb total:"
    - "L1                                                                                                                 "
    - "L1.111[300,399] 1.05us 54mb|----------------------------------------L1.111-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.4[300,399] 399ns 100mb|-----------------------------------------L2.4------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 154mb total:"
    - "L2                                                                                                                 "
    - "L2.?[300,365] 1.05us 102mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[366,399] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.4, L1.111"
    - "  Creating 2 files"
    - "**** Simulation run 28, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[465]). 3 Input Files, 154mb total:"
    - "L1                                                                                                                 "
    - "L1.112[400,446] 1.05us 25mb|----------------L1.112-----------------|                                                 "
    - "L1.107[447,499] 1.05us 29mb                                          |-------------------L1.107--------------------| "
    - "L2                                                                                                                 "
    - "L2.5[400,499] 499ns 100mb|-----------------------------------------L2.5------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 154mb total:"
    - "L2                                                                                                                 "
    - "L2.?[400,465] 1.05us 102mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[466,499] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.5, L1.107, L1.112"
    - "  Creating 2 files"
    - "**** Simulation run 29, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[565]). 2 Input Files, 154mb total:"
    - "L1                                                                                                                 "
    - "L1.108[500,599] 1.05us 54mb|----------------------------------------L1.108-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.6[500,599] 599ns 100mb|-----------------------------------------L2.6------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 154mb total:"
    - "L2                                                                                                                 "
    - "L2.?[500,565] 1.05us 102mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[566,599] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.6, L1.108"
    - "  Creating 2 files"
    - "**** Simulation run 30, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[665]). 4 Input Files, 154mb total:"
    - "L1                                                                                                                 "
    - "L1.109[600,631] 1.05us 17mb|----------L1.109----------|                                                              "
    - "L1.104[632,696] 1.05us 35mb                             |-------------------------L1.104-------------------------|   "
    - "L1.118[697,699] 1.05us 2mb                                                                                        |L1.118|"
    - "L2                                                                                                                 "
    - "L2.7[600,699] 699ns 100mb|-----------------------------------------L2.7------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 154mb total:"
    - "L2                                                                                                                 "
    - "L2.?[600,665] 1.05us 102mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[666,699] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L2.7, L1.104, L1.109, L1.118"
    - "  Creating 2 files"
    - "**** Simulation run 31, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[764]). 2 Input Files, 156mb total:"
    - "L1                                                                                                                 "
    - "L1.119[700,799] 1.05us 56mb|----------------------------------------L1.119-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.8[700,799] 799ns 100mb|-----------------------------------------L2.8------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 156mb total:"
    - "L2                                                                                                                 "
    - "L2.?[700,764] 1.05us 102mb|--------------------------L2.?--------------------------|                                "
    - "L2.?[765,799] 1.05us 55mb                                                           |------------L2.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.8, L1.119"
    - "  Creating 2 files"
    - "**** Simulation run 32, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[864]). 3 Input Files, 156mb total:"
    - "L1                                                                                                                 "
    - "L1.120[800,874] 1.05us 42mb|-----------------------------L1.120------------------------------|                       "
    - "L1.116[875,899] 1.05us 14mb                                                                    |------L1.116-------| "
    - "L2                                                                                                                 "
    - "L2.9[800,899] 899ns 100mb|-----------------------------------------L2.9------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 156mb total:"
    - "L2                                                                                                                 "
    - "L2.?[800,864] 1.05us 102mb|--------------------------L2.?--------------------------|                                "
    - "L2.?[865,899] 1.05us 55mb                                                           |------------L2.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.9, L1.116, L1.120"
    - "  Creating 2 files"
    - "**** Final Output Files (4.05gb written)"
    - "L1                                                                                                                 "
    - "L1.117[900,986] 1.05us 49mb                                                                                 |L1.117| "
    - "L2                                                                                                                 "
    - "L2.10[900,999] 999ns 100mb                                                                                 |L2.10-| "
    - "L2.121[0,74] 1.05us 102mb|L2.121|                                                                                  "
    - "L2.122[75,148] 1.05us 101mb      |L2.122|                                                                            "
    - "L2.123[149,199] 1.05us 69mb             |L2.123|                                                                     "
    - "L2.124[200,267] 1.05us 101mb                  |L2.124|                                                                "
    - "L2.125[268,299] 1.05us 48mb                        |L2.125|                                                          "
    - "L2.126[300,365] 1.05us 102mb                           |L2.126|                                                       "
    - "L2.127[366,399] 1.05us 52mb                                |L2.127|                                                  "
    - "L2.128[400,465] 1.05us 102mb                                    |L2.128|                                              "
    - "L2.129[466,499] 1.05us 52mb                                         |L2.129|                                         "
    - "L2.130[500,565] 1.05us 102mb                                             |L2.130|                                     "
    - "L2.131[566,599] 1.05us 52mb                                                  |L2.131|                                "
    - "L2.132[600,665] 1.05us 102mb                                                      |L2.132|                            "
    - "L2.133[666,699] 1.05us 52mb                                                            |L2.133|                      "
    - "L2.134[700,764] 1.05us 102mb                                                               |L2.134|                   "
...
async fn actual_case_from_catalog_1() {
    ...
    - "**** Final Output Files (15.33gb written)"
    - "L2                                                                                                                 "
    - "L2.598[150,165] 342ns 224mb                                       |L2.598|                                           "
    - "L2.599[166,171] 342ns 108mb                                           |L2.599|                                       "
    - "L2.602[183,197] 342ns 267mb                                                |L2.602|                                  "
    - "L2.603[198,207] 342ns 157mb                                                    |L2.603|                              "
    - "L2.604[208,220] 342ns 149mb                                                       |L2.604|                           "
    - "L2.605[221,232] 342ns 279mb                                                          |L2.605|                        "
    - "L2.606[233,244] 342ns 136mb                                                             |L2.606|                     "
    - "L2.607[245,253] 342ns 144mb                                                                |L2.607|                  "
    - "L2.608[254,261] 342ns 118mb                                                                   |L2.608|               "
    - "L2.609[262,270] 342ns 167mb                                                                     |L2.609|             "
    - "L2.614[297,299] 342ns 110mb                                                                              |L2.614|    "
    - "L2.615[300,302] 342ns 125mb                                                                               |L2.615|   "
    - "L2.616[303,305] 342ns 142mb                                                                                |L2.616|  "
    - "L2.617[306,308] 342ns 155mb                                                                                 |L2.617| "
    - "L2.618[271,276] 342ns 122mb                                                                       |L2.618|           "
    - "L2.619[277,281] 342ns 112mb                                                                         |L2.619|         "
    - "L2.620[309,311] 342ns 151mb                                                                                  |L2.620|"
    - "L2.621[312,314] 342ns 157mb                                                                                  |L2.621|"
    - "L2.622[315,317] 342ns 194mb                                                                                   |L2.622|"
    - "L2.623[318,320] 342ns 215mb                                                                                    |L2.623|"
    - "L2.624[321,323] 342ns 210mb                                                                                     |L2.624|"
    - "L2.625[324,326] 342ns 194mb                                                                                      |L2.625|"
    - "L2.626[327,329] 342ns 179mb                                                                                      |L2.626|"
    - "L2.627[330,332] 342ns 235mb                                                                                       |L2.627|"
    - "L2.628[333,335] 342ns 211mb                                                                                        |L2.628|"
    - "L2.629[336,339] 342ns 187mb                                                                                         |L2.629|"
    - "L2.630[1,33] 342ns 102mb |L2.630|                                                                                  "
    - "L2.633[34,57] 342ns 104mb        |L2.633|                                                                          "
    - "L2.644[125,130] 342ns 104mb                                 |L2.644|                                                 "
    - "L2.646[172,177] 342ns 114mb                                             |L2.646|                                     "
    - "L2.650[58,74] 342ns 106mb               |L2.650|                                                                   "
    - "L2.651[75,80] 342ns 38mb                    |L2.651|                                                               "
    - "L2.652[81,91] 342ns 113mb                     |L2.652|                                                             "
    - "L2.653[92,101] 342ns 102mb                        |L2.653|                                                          "
    - "L2.654[102,106] 342ns 51mb                          |L2.654|                                                        "
    - "L2.655[107,116] 342ns 116mb                            |L2.655|                                                      "
    - "L2.656[117,124] 342ns 93mb                              |L2.656|                                                    "
    - "L2.657[282,287] 342ns 114mb                                                                          |L2.657|        "
    - "L2.660[131,139] 342ns 121mb                                  |L2.660|                                                "
    - "L2.661[140,147] 342ns 108mb                                     |L2.661|                                             "
    - "L2.662[148,149] 342ns 27mb                                       |L2.662|                                           "
    - "L2.663[178,181] 342ns 76mb                                               |L2.663|                                   "
    ...
    - "WARNING: file L2.605[221,232] 342ns 279mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.609[262,270] 342ns 167mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.617[306,308] 342ns 155mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.620[309,311] 342ns 151mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.621[312,314] 342ns 157mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.622[315,317] 342ns 194mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.623[318,320] 342ns 215mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.624[321,323] 342ns 210mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.625[324,326] 342ns 194mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.626[327,329] 342ns 179mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.627[330,332] 342ns 235mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.628[333,335] 342ns 211mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.629[336,339] 342ns 187mb exceeds soft limit 100mb by more than 50%"
    "###
    );
}
