...
async fn random_backfill_empty_partition() {
    ...
    - "  Creating 3 files"
    - "**** Simulation run 7, type=split(ReduceOverlap)(split_times=[714]). 1 Input Files, 67mb total:"
    - "L0, all files 67mb                                                                                                 "
    ...
    - "**** Simulation run 8, type=split(ReduceOverlap)(split_times=[357]). 1 Input Files, 66mb total:"
    - "L0, all files 66mb                                                                                                 "
    ...
    - "**** Simulation run 9, type=split(ReduceOverlap)(split_times=[714]). 1 Input Files, 34mb total:"
    - "L0, all files 34mb                                                                                                 "
    ...
    - "**** Simulation run 10, type=split(ReduceOverlap)(split_times=[357]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L0.59, L0.60, L0.62, L0.63"
    - "  Creating 8 files"
    - "**** Simulation run 11, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[260, 520]). 5 Input Files, 275mb total:"
    - "L0                                                                                                                 "
    - "L0.69[357,357] 1.04us 0b                                              |L0.69|                                      "
    - "L0.70[358,670] 1.04us 66mb                                             |----------------L0.70----------------|      "
    - "L0.67[671,714] 1.04us 9mb                                                                                    |L0.67|"
    - "L1                                                                                                                 "
    - "L1.64[0,357] 1.04us 100mb|-------------------L1.64-------------------|                                             "
    - "L1.65[358,714] 1.04us 100mb                                             |------------------L1.65-------------------| "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 5 files: L1.64, L1.65, L0.67, L0.69, L0.70"
    - "  Creating 3 files"
    - "**** Simulation run 12, type=split(ReduceOverlap)(split_times=[520]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.74[358,670] 1.05us    |-----------------------------------------L0.74------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[358,520] 1.05us 17mb|--------------------L0.?--------------------|                                            "
    - "L0.?[521,670] 1.05us 16mb                                               |------------------L0.?------------------| "
    - "**** Simulation run 13, type=split(ReduceOverlap)(split_times=[260]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.61, L0.74"
    - "  Creating 4 files"
    - "**** Simulation run 14, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[917]). 2 Input Files, 135mb total:"
    - "L0                                                                                                                 "
    - "L0.68[715,986] 1.04us 58mb|-----------------------------------------L0.68------------------------------------------|"
    - "L1                                                                                                                 "
    - "L1.66[715,986] 1.04us 77mb|-----------------------------------------L1.66------------------------------------------|"
    ...
    - "  Creating 2 files"
    - "**** Simulation run 15, type=split(ReduceOverlap)(split_times=[917]). 1 Input Files, 29mb total:"
    - "L0, all files 29mb                                                                                                 "
    - "L0.72[715,986] 1.05us    |-----------------------------------------L0.72------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 29mb total:"
    - "L0                                                                                                                 "
    - "L0.?[715,917] 1.05us 22mb|------------------------------L0.?-------------------------------|                       "
    - "L0.?[918,986] 1.05us 7mb                                                                    |--------L0.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L0.72"
    - "  Creating 2 files"
    - "**** Simulation run 16, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[208, 416]). 6 Input Files, 251mb total:"
    - "L0                                                                                                                 "
    - "L0.80[42,260] 1.05us 23mb       |---------------L0.80---------------|                                              "
    - "L0.81[261,356] 1.05us 10mb                                             |----L0.81-----|                             "
    - "L0.73[357,357] 1.05us 0b                                                              |L0.73|                      "
    - "L0.78[358,520] 1.05us 17mb                                                             |----------L0.78-----------| "
    - "L1                                                                                                                 "
    - "L1.75[0,260] 1.04us 100mb|-------------------L1.75-------------------|                                             "
    - "L1.76[261,520] 1.04us 100mb                                             |------------------L1.76-------------------| "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L0.73, L1.75, L1.76, L0.78, L0.80, L0.81"
    - "  Creating 3 files"
    - "**** Simulation run 17, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[701, 881]). 7 Input Files, 259mb total:"
    - "L0                                                                                                                 "
    - "L0.85[918,986] 1.05us 7mb                                                                            |---L0.85---| "
    - "L0.84[715,917] 1.05us 22mb                                     |----------------L0.84----------------|              "
    - "L0.71[671,714] 1.05us 5mb                             |L0.71-|                                                     "
    - "L0.79[521,670] 1.05us 16mb|----------L0.79-----------|                                                              "
    - "L1                                                                                                                 "
    - "L1.83[918,986] 1.04us 34mb                                                                            |---L1.83---| "
    - "L1.82[715,917] 1.04us 100mb                                     |----------------L1.82----------------|              "
    - "L1.77[521,714] 1.04us 75mb|---------------L1.77---------------|                                                     "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 7 files: L0.71, L1.77, L0.79, L1.82, L1.83, L0.84, L0.85"
    - "  Creating 3 files"
    - "**** Simulation run 18, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[406, 603]). 3 Input Files, 251mb total:"
    - "L1                                                                                                                 "
    - "L1.87[209,416] 1.05us 100mb|---------------L1.87---------------|                                                     "
    - "L1.88[417,520] 1.05us 51mb                                      |-----L1.88------|                                  "
    - "L1.89[521,701] 1.05us 100mb                                                         |------------L1.89-------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 251mb total:"
    - "L2                                                                                                                 "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L1.87, L1.88, L1.89"
    - "  Upgrading 1 files level to CompactionLevel::L2: L1.86"
    - "  Creating 3 files"
    - "**** Simulation run 19, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[881]). 2 Input Files, 159mb total:"
    - "L1                                                                                                                 "
    - "L1.91[882,986] 1.05us 59mb                                                         |------------L1.91-------------| "
    - "L1.90[702,881] 1.05us 100mb|------------------------L1.90-------------------------|                                  "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 159mb total:"
    - "L2                                                                                                                 "
    - "L2.?[702,881] 1.05us 100mb|-------------------------L2.?-------------------------|                                  "
    - "L2.?[882,986] 1.05us 59mb                                                         |-------------L2.?-------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L1.90, L1.91"
    - "  Creating 2 files"
    - "**** Final Output Files (2.83gb written)"
    - "L2                                                                                                                 "
    - "L2.86[0,208] 1.05us 100mb|-----L2.86------|                                                                        "
    - "L2.92[209,406] 1.05us 100mb                   |-----L2.92-----|                                                      "
    - "L2.93[407,603] 1.05us 100mb                                     |-----L2.93-----|                                    "
    - "L2.94[604,701] 1.05us 50mb                                                       |L2.94-|                           "
    - "L2.95[702,881] 1.05us 100mb                                                                |----L2.95-----|          "
    - "L2.96[882,986] 1.05us 59mb                                                                                |-L2.96-| "
    "###
    );
}
...
async fn random_backfill_over_l2s() {
    ...
    - "  Creating 5 files"
    - "**** Simulation run 18, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[447, 633]). 6 Input Files, 235mb total:"
    - "L0                                                                                                                 "
    - "L0.100[358,478] 1.05us 13mb                    |--------L0.100--------|                                              "
    - "L0.101[479,670] 1.05us 20mb                                             |---------------L0.101----------------|      "
    - "L0.88[671,672] 1.05us 109kb                                                                                    |L0.88|"
    - "L0.97[673,696] 1.05us 2mb                                                                                     |L0.97|"
    - "L1                                                                                                                 "
    ...
    - "L1                                                                                                                 "
    - "L1.?[261,447] 1.05us 100mb|----------------L1.?----------------|                                                    "
    - "L1.?[448,633] 1.05us 100mb                                      |----------------L1.?----------------|              "
    - "L1.?[634,696] 1.05us 35mb                                                                             |---L1.?---| "
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L0.88, L1.93, L1.94, L0.97, L0.100, L0.101"
    - "  Creating 3 files"
    - "**** Simulation run 19, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[873]). 4 Input Files, 165mb total:"
    - "L0                                                                                                                 "
    - "L0.99[915,986] 1.05us 8mb                                                                   |-------L0.99--------| "
    - "L0.98[697,914] 1.05us 23mb|------------------------------L0.98------------------------------|                       "
    - "L1                                                                                                                 "
    - "L1.96[915,986] 1.05us 34mb                                                                   |-------L1.96--------| "
    - "L1.95[697,914] 1.05us 100mb|------------------------------L1.95------------------------------|                       "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 165mb total:"
    - "L1                                                                                                                 "
    - "L1.?[697,873] 1.05us 101mb|------------------------L1.?------------------------|                                    "
    - "L1.?[874,986] 1.05us 65mb                                                       |--------------L1.?--------------| "
    - "Committing partition 1:"
    ...
    - "L1, all files 100mb                                                                                                "
    - "L1.103[448,633] 1.05us   |-----------------------------------------L1.103-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[448,499] 1.05us 28mb|---------L1.?---------|                                                                  "
    - "L1.?[500,599] 1.05us 53mb                         |---------------------L1.?---------------------|                 "
    - "L1.?[600,633] 1.05us 19mb                                                                         |-----L1.?-----| "
    - "**** Simulation run 21, type=split(ReduceOverlap)(split_times=[299, 399]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.102[261,447] 1.05us   |----------------------------------------L1.102-----------------------------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[261,299] 1.05us 21mb|------L1.?------|                                                                        "
    - "L1.?[300,399] 1.05us 53mb                  |--------------------L1.?---------------------|                         "
    - "L1.?[400,447] 1.05us 26mb                                                                   |--------L1.?--------| "
    ...
    - "L1.?[100,199] 1.05us 45mb                       |-----------------L1.?-----------------|                           "
    - "L1.?[200,260] 1.05us 28mb                                                                 |---------L1.?---------| "
    - "**** Simulation run 23, type=split(ReduceOverlap)(split_times=[899]). 1 Input Files, 65mb total:"
    - "L1, all files 65mb                                                                                                 "
    - "L1.106[874,986] 1.05us   |-----------------------------------------L1.106-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 65mb total:"
    - "L1                                                                                                                 "
    - "L1.?[874,899] 1.05us 14mb|-------L1.?-------|                                                                      "
    - "L1.?[900,986] 1.05us 50mb                    |-------------------------------L1.?--------------------------------| "
    - "**** Simulation run 24, type=split(ReduceOverlap)(split_times=[699, 799]). 1 Input Files, 101mb total:"
    - "L1, all files 101mb                                                                                                "
    - "L1.105[697,873] 1.05us   |-----------------------------------------L1.105-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 101mb total:"
    - "L1                                                                                                                 "
    - "L1.?[697,699] 1.05us 1mb |L1.?|                                                                                    "
    - "L1.?[700,799] 1.05us 57mb |----------------------L1.?----------------------|                                       "
    - "L1.?[800,873] 1.05us 43mb                                                    |---------------L1.?----------------| "
    - "Committing partition 1:"
    ...
    - "L1                                                                                                                 "
    - "L1.113[42,99] 1.05us 26mb                  |--------L1.113---------|                                               "
    - "L1.114[100,199] 1.05us 45mb                                             |------------------L1.114------------------| "
    - "L2                                                                                                                 "
    - "L2.1[0,99] 99ns 100mb    |-------------------L2.1-------------------|                                              "
    - "L2.2[100,199] 199ns 100mb                                             |-------------------L2.2-------------------| "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 27, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[365]). 2 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.111[300,399] 1.05us 53mb|----------------------------------------L1.111-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.4[300,399] 399ns 100mb|-----------------------------------------L2.4------------------------------------------| "
    ...
    - "L1                                                                                                                 "
    - "L1.112[400,447] 1.05us 26mb|-----------------L1.112-----------------|                                                "
    - "L1.107[448,499] 1.05us 28mb                                           |-------------------L1.107-------------------| "
    - "L2                                                                                                                 "
    - "L2.5[400,499] 499ns 100mb|-----------------------------------------L2.5------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 154mb total:"
    - "L2                                                                                                                 "
    - "L2.?[400,465] 1.05us 101mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[466,499] 1.05us 53mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.5, L1.107, L1.112"
    - "  Creating 2 files"
    - "**** Simulation run 29, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[565]). 2 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.108[500,599] 1.05us 53mb|----------------------------------------L1.108-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.6[500,599] 599ns 100mb|-----------------------------------------L2.6------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    ...
    - "  Creating 2 files"
    - "**** Simulation run 30, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[665]). 4 Input Files, 155mb total:"
    - "L1                                                                                                                 "
    - "L1.109[600,633] 1.05us 19mb|----------L1.109-----------|                                                             "
    - "L1.104[634,696] 1.05us 35mb                              |------------------------L1.104------------------------|    "
    - "L1.118[697,699] 1.05us 1mb                                                                                        |L1.118|"
    - "L2                                                                                                                 "
    - "L2.7[600,699] 699ns 100mb|-----------------------------------------L2.7------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 155mb total:"
    - "L2                                                                                                                 "
    - "L2.?[600,665] 1.05us 102mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[666,699] 1.05us 53mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L2.7, L1.104, L1.109, L1.118"
    - "  Creating 2 files"
    - "**** Simulation run 31, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[764]). 2 Input Files, 157mb total:"
    - "L1                                                                                                                 "
    - "L1.119[700,799] 1.05us 57mb|----------------------------------------L1.119-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.8[700,799] 799ns 100mb|-----------------------------------------L2.8------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 157mb total:"
    - "L2                                                                                                                 "
    - "L2.?[700,764] 1.05us 101mb|--------------------------L2.?--------------------------|                                "
    - "L2.?[765,799] 1.05us 55mb                                                           |------------L2.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.8, L1.119"
    - "  Creating 2 files"
    - "**** Simulation run 32, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[863]). 3 Input Files, 157mb total:"
    - "L1                                                                                                                 "
    - "L1.120[800,873] 1.05us 43mb|-----------------------------L1.120-----------------------------|                        "
    - "L1.116[874,899] 1.05us 14mb                                                                   |-------L1.116-------| "
    - "L2                                                                                                                 "
    - "L2.9[800,899] 899ns 100mb|-----------------------------------------L2.9------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 157mb total:"
    - "L2                                                                                                                 "
    - "L2.?[800,863] 1.05us 100mb|-------------------------L2.?--------------------------|                                 "
    - "L2.?[864,899] 1.05us 57mb                                                          |------------L2.?-------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.9, L1.116, L1.120"
    - "  Creating 2 files"
    - "**** Final Output Files (4.05gb written)"
    - "L1                                                                                                                 "
    - "L1.117[900,986] 1.05us 50mb                                                                                 |L1.117| "
    - "L2                                                                                                                 "
    - "L2.10[900,999] 999ns 100mb                                                                                 |L2.10-| "
    - "L2.121[0,74] 1.05us 101mb|L2.121|                                                                                  "
    - "L2.122[75,148] 1.05us 100mb      |L2.122|                                                                            "
    - "L2.123[149,199] 1.05us 71mb             |L2.123|                                                                     "
    - "L2.124[200,267] 1.05us 101mb                  |L2.124|                                                                "
    - "L2.125[268,299] 1.05us 48mb                        |L2.125|                                                          "
    - "L2.126[300,365] 1.05us 101mb                           |L2.126|                                                       "
    - "L2.127[366,399] 1.05us 53mb                                |L2.127|                                                  "
    - "L2.128[400,465] 1.05us 101mb                                    |L2.128|                                              "
    - "L2.129[466,499] 1.05us 53mb                                         |L2.129|                                         "
    - "L2.130[500,565] 1.05us 101mb                                             |L2.130|                                     "
    - "L2.131[566,599] 1.05us 53mb                                                  |L2.131|                                "
    - "L2.132[600,665] 1.05us 102mb                                                      |L2.132|                            "
    - "L2.133[666,699] 1.05us 53mb                                                            |L2.133|                      "
    - "L2.134[700,764] 1.05us 101mb                                                               |L2.134|                   "
    - "L2.135[765,799] 1.05us 55mb                                                                    |L2.135|              "
    - "L2.136[800,863] 1.05us 100mb                                                                        |L2.136|          "
    - "L2.137[864,899] 1.05us 57mb                                                                             |L2.137|     "
    "###
    );
}
...
async fn actual_case_from_catalog_1() {
    ...
    - "**** Final Output Files (15.11gb written)"
    - "L2                                                                                                                 "
    ...
    - "L2.600[245,253] 342ns 139mb                                                                |L2.600|                  "
    - "L2.601[254,261] 342ns 105mb                                                                   |L2.601|               "
    - "L2.602[262,270] 342ns 184mb                                                                     |L2.602|             "
    - "L2.603[271,276] 342ns 117mb                                                                       |L2.603|           "
    - "L2.604[277,281] 342ns 109mb                                                                         |L2.604|         "
    - "L2.607[297,299] 342ns 141mb                                                                              |L2.607|    "
    - "L2.611[309,311] 342ns 101mb                                                                                  |L2.611|"
    - "L2.612[312,314] 342ns 181mb                                                                                  |L2.612|"
    - "L2.613[315,317] 342ns 214mb                                                                                   |L2.613|"
    ...
    - "L2.624[1,36] 342ns 103mb |L2.624-|                                                                                 "
    - "L2.625[37,71] 342ns 103mb         |L2.625-|                                                                        "
    - "L2.626[72,83] 342ns 103mb                  |L2.626|                                                                "
    - "L2.634[84,94] 342ns 107mb                      |L2.634|                                                            "
    - "L2.635[95,104] 342ns 97mb                         |L2.635|                                                         "
    - "L2.636[105,111] 342ns 86mb                           |L2.636|                                                       "
    - "L2.637[172,177] 342ns 109mb                                             |L2.637|                                     "
    - "L2.638[178,182] 342ns 109mb                                               |L2.638|                                   "
    - "L2.639[112,119] 342ns 114mb                             |L2.639|                                                     "
    - "L2.640[120,126] 342ns 98mb                               |L2.640|                                                   "
    - "L2.641[127,130] 342ns 82mb                                 |L2.641|                                                 "
    - "L2.642[282,288] 342ns 100mb                                                                          |L2.642|        "
    - "L2.645[131,132] 342ns 38mb                                  |L2.645|                                                "
    - "L2.646[133,133] 342ns 38mb                                   |L2.646|                                               "
    - "L2.647[289,295] 342ns 115mb                                                                            |L2.647|      "
    - "L2.648[296,296] 342ns 19mb                                                                              |L2.648|    "
    - "L2.649[300,303] 342ns 110mb                                                                               |L2.649|   "
    - "L2.652[304,306] 342ns 113mb                                                                                |L2.652|  "
    - "L2.653[307,308] 342ns 113mb                                                                                 |L2.653| "
    - "L2.654[339,339] 342ns 25mb                                                                                          |L2.654|"
    ...
    - "WARNING: file L2.602[262,270] 342ns 184mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.612[312,314] 342ns 181mb exceeds soft limit 100mb by more than 50%"
    - "WARNING: file L2.613[315,317] 342ns 214mb exceeds soft limit 100mb by more than 50%"
