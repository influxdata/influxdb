...
fn maybe_print_help() {
    ...
    if help {
        match command {
            None => println!(include_str!("help/influxdb3.txt")),
            ...
            Some(SubCommand::Serve) => println!(include_str!("help/serve.txt")),
        ...
        match command {
            None => println!(include_str!("help/influxdb3_all.txt")),
            ...
            Some(SubCommand::Serve) => println!(include_str!("help/serve_all.txt")),
