...
func (c *Client) FindOrganization(ctx context.Context, filter influxdb.OrganizationFilter) (*influxdb.Organization, error) {
	...
	var o *influxdb.Organization
	err := c.db.View(func(tx *bolt.Tx) error {
		return forEachOrganization(ctx, tx, false, func(org *influxdb.Organization) bool {
			if filterFn(org) {
				o = org
				return false
			}
...
func forEachOrganization(ctx context.Context, tx *bolt.Tx, descending bool, fn func(*influxdb.Organization) bool) error {
