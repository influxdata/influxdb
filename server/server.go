...
type Server struct {
	...
	StatusFeedURL string `long:"status-feed-url" description:"URL of a JSON Feed to display as a News Feed on the client Status page." default:"http://news.influxdata.com/feed.json" env:"STATUS_FEED_URL"`
